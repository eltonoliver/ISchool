...
$_SESSION['scriptcase']['dashboard']['glo_nm_path_prod']       = "/scriptcase/prod";
$_SESSION['scriptcase']['dashboard']['glo_nm_path_imagens']    = "/scriptcase/file/img";
$_SESSION['scriptcase']['dashboard']['glo_nm_path_imag_temp']  = "/scriptcase/tmp";
$_SESSION['scriptcase']['dashboard']['glo_nm_path_doc']        = "";
$_SESSION['scriptcase']['dashboard']['glo_nm_conexao']         = "";
...
?>
  ...
  <li class="scContainerWidget widget" id="widget1">
   <div class="widget-head scContainerTitle">
    <h3 id="id-title-widget1">Alunos Ativos</h3>
   </div>
   <div class="widget-content" style="height: 400px; padding: 0px">
    <iframe id="id-iframe-widget1" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('grid_tbl_aluno_1'); ?>/?script_case_session=<?php echo session_id(); ?>"></iframe>
   </div>
  </li>
...
?>
  ...
  <li class="scContainerWidget widget" id="widget2">
   <div class="widget-head scContainerTitle">
    ...
    <h3 id="id-title-widget2">Calendário de Turma</h3>
   </div>
   <div class="widget-content" style="height: 400px; padding: 0px">
    <iframe id="id-iframe-widget2" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('calendar_tbl_calendario_turma'); ?>/?script_case_session=<?php echo session_id(); ?>"></iframe>
   </div>
  </li>
...
var widgets_indiv = { widget1: { movable: true, removable: false, collapsible: false, editable: false }, widget2: { movable: true, removable: false, collapsible: true, editable: false } };
</script>
