<?php  
  session_start() ;
  class dashboard_form_teste
  {
   function dashboard_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "dashboard/img";
  if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'dashboard')
  {
...
<?php
  ...
  $frm_teste = new dashboard_form_teste();
  $frm_teste->dashboard_teste();
?>
