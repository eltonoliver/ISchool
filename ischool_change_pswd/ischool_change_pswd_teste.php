<?php  
  session_start() ;
  class ischool_change_pswd_form_teste
  {
   function ischool_change_pswd_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "ischool_change_pswd/img";
...
?> 
<br> 
<B><FONT SIZE="4">ischool_change_pswd</FONT></B> 
<br> 
<form name="Fedit" method="post" 
               action="index.php" 
               target="_self"> 
<input type="hidden" name="script_case_session" value="<?php echo session_id() ?>"/><input type="hidden" name="nmgp_outra_jan" value="true"/>act_code&nbsp;&nbsp;<input type="text" name="act_code" size=20><br> 
usr_login&nbsp;&nbsp;<input type="text" name="usr_login" size=20><br> 
<input type="hidden" name="NM_contr_var_session" value="Yes"> 
<input type="submit" value="ischool_change_pswd"> 
</form> 
...
<?php
  ...
  $frm_teste = new ischool_change_pswd_form_teste();
  $frm_teste->ischool_change_pswd_teste();
?>
