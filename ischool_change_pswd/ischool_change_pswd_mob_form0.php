...
<?php
include_once("ischool_change_pswd_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('ischool_change_pswd_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['ischool_change_pswd_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['ischool_change_pswd_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['ischool_change_pswd_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['ischool_change_pswd_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['ischool_change_pswd_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['ischool_change_pswd_mob']['recarga'];
}
?>
...
<?php
 include_once("ischool_change_pswd_mob_js0.php");
?>
...
<form name="F1" method="post" 
               action="ischool_change_pswd_mob.php" 
               target="_self"> 
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['ischool_change_pswd_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['ischool_change_pswd_mob']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['ischool_change_pswd_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['ischool_change_pswd_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ischool_change_pswd_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['ischool_change_pswd_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['ischool_change_pswd_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['ischool_change_pswd_mob']['empty_filter'] = true;
       }
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_pswd" style="<?php echo $sStyleHidden_pswd; ?>;"> <span class="scFormLabelOddFormat" style=";" ><span id="id_label_pswd"><?php echo $this->nm_new_label['pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ischool_change_pswd_mob']['php_cmp_required']['pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['ischool_change_pswd_mob']['php_cmp_required']['pswd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_confirm_pswd" style="<?php echo $sStyleHidden_confirm_pswd; ?>;"> <span class="scFormLabelOddFormat" style=";" ><span id="id_label_confirm_pswd"><?php echo $this->nm_new_label['confirm_pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ischool_change_pswd_mob']['php_cmp_required']['confirm_pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['ischool_change_pswd_mob']['php_cmp_required']['confirm_pswd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
?>
<script>
 parent.scAjaxDetailStatus("ischool_change_pswd_mob");
 parent.scAjaxDetailHeight("ischool_change_pswd_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
