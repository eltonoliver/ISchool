  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_ischool_change_pswd_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate old_pswd
  function do_ajax_ischool_change_pswd_mob_validate_old_pswd()
  {
    var nomeCampo_old_pswd = "old_pswd";
    var var_old_pswd = scAjaxGetFieldText(nomeCampo_old_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_ischool_change_pswd_mob_validate_old_pswd(var_old_pswd, var_script_case_init, do_ajax_ischool_change_pswd_mob_validate_old_pswd_cb);
  } // do_ajax_ischool_change_pswd_mob_validate_old_pswd

  function do_ajax_ischool_change_pswd_mob_validate_old_pswd_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ischool_change_pswd_mob_validate_old_pswd_cb

  // ---------- Validate pswd
  function do_ajax_ischool_change_pswd_mob_validate_pswd()
  {
    var nomeCampo_pswd = "pswd";
    var var_pswd = scAjaxGetFieldText(nomeCampo_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_ischool_change_pswd_mob_validate_pswd(var_pswd, var_script_case_init, do_ajax_ischool_change_pswd_mob_validate_pswd_cb);
  } // do_ajax_ischool_change_pswd_mob_validate_pswd

  function do_ajax_ischool_change_pswd_mob_validate_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pswd";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ischool_change_pswd_mob_validate_pswd_cb

  // ---------- Validate confirm_pswd
  function do_ajax_ischool_change_pswd_mob_validate_confirm_pswd()
  {
    var nomeCampo_confirm_pswd = "confirm_pswd";
    var var_confirm_pswd = scAjaxGetFieldText(nomeCampo_confirm_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_ischool_change_pswd_mob_validate_confirm_pswd(var_confirm_pswd, var_script_case_init, do_ajax_ischool_change_pswd_mob_validate_confirm_pswd_cb);
  } // do_ajax_ischool_change_pswd_mob_validate_confirm_pswd

  function do_ajax_ischool_change_pswd_mob_validate_confirm_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ischool_change_pswd_mob_validate_confirm_pswd_cb
  // ---------- Form
  function do_ajax_ischool_change_pswd_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_ischool_change_pswd_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_ischool_change_pswd_mob_submit_form(var_old_pswd, var_pswd, var_confirm_pswd, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_ischool_change_pswd_mob_submit_form_cb);
  } // do_ajax_ischool_change_pswd_mob_submit_form

  function do_ajax_ischool_change_pswd_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_ischool_change_pswd_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_ischool_change_pswd_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_ischool_change_pswd_mob_navigate_form

  function do_ajax_ischool_change_pswd_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_ischool_change_pswd_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_ischool_change_pswd_mob_navigate_form_cb
