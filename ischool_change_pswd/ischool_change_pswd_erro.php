...
$old_error_handler = set_error_handler("ischool_change_pswd_scriptcase_error_handler");

function ischool_change_pswd_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['ischool_change_pswd']['contr_erro']) && $_SESSION['scriptcase']['ischool_change_pswd']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_ischool_change_pswd->contr_ischool_change_pswd->Apl_com_erro = true;
            if ($inicial_ischool_change_pswd->contr_ischool_change_pswd->NM_ajax_flag)
            {
                $inicial_ischool_change_pswd->contr_ischool_change_pswd->NM_ajax_info['errList']['geral_ischool_change_pswd'][] = $msg;
                return;
            }
            ischool_change_pswd_scriptcase_error_display($msg, $err_no);
        }
...
function ischool_change_pswd_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['ischool_change_pswd'])  && '' != $_SESSION['scriptcase']['error_icon']['ischool_change_pswd'])  ? $_SESSION['scriptcase']['error_icon']['ischool_change_pswd']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['ischool_change_pswd']) && '' != $_SESSION['scriptcase']['error_close']['ischool_change_pswd']) ? $_SESSION['scriptcase']['error_close']['ischool_change_pswd'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['ischool_change_pswd']) && '' != $_SESSION['scriptcase']['error_span_title']['ischool_change_pswd']) ? $_SESSION['scriptcase']['error_span_title']['ischool_change_pswd'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['ischool_change_pswd']) && '' != $_SESSION['scriptcase']['error_icon_title']['ischool_change_pswd']) ? $_SESSION['scriptcase']['error_icon_title']['ischool_change_pswd'] : '';
?>
