<?php  
  ...
  session_start() ;
  class grid_tbl_turma_form_teste
  {
  function grid_tbl_turma_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_tbl_turma</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_tbl_turma"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_tbl_turma_form_teste();
  $frm_teste->grid_tbl_turma_teste();
?>
