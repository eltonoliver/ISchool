<?php
   ...
   session_start();
    $Ord_Cmp = new grid_tbl_turma_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_tbl_turma_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_converte["id"]   = "id";
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['labels']["id"] : "Código";
   $tab_ger_campos['tbl_curso_id'] = "on";
   $tab_def_campos['tbl_curso_id'] = "tbl_curso_id";
   $tab_converte["tbl_curso_id"]   = "tbl_curso_id";
   $tab_labels["tbl_curso_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['labels']["tbl_curso_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['labels']["tbl_curso_id"] : "Curso";
   $tab_ger_campos['nivel'] = "on";
   $tab_def_campos['nivel'] = "nivel";
   $tab_converte["nivel"]   = "nivel";
   $tab_labels["nivel"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['labels']["nivel"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['labels']["nivel"] : "Nível";
   $tab_ger_campos['periodoletivo'] = "on";
   $tab_def_campos['periodoletivo'] = "periodoLetivo";
   $tab_converte["periodoLetivo"]   = "periodoletivo";
   $tab_labels["periodoletivo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['labels']["periodoletivo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['labels']["periodoletivo"] : "Período Letivo";
   $tab_ger_campos['nome'] = "on";
   $tab_def_campos['nome'] = "nome";
   $tab_converte["nome"]   = "nome";
   $tab_labels["nome"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['labels']["nome"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['labels']["nome"] : "Nome";
   $tab_ger_campos['abreviacao'] = "on";
   $tab_def_campos['abreviacao'] = "abreviacao";
   $tab_converte["abreviacao"]   = "abreviacao";
   $tab_labels["abreviacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['labels']["abreviacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['labels']["abreviacao"] : "Abreviação";
   $tab_ger_campos['turno'] = "on";
   $tab_def_campos['turno'] = "turno";
   $tab_converte["turno"]   = "turno";
   $tab_labels["turno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['labels']["turno"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['labels']["turno"] : "Turno";
   $tab_ger_campos['qtdvagas'] = "on";
   $tab_def_campos['qtdvagas'] = "qtdVagas";
   $tab_converte["qtdVagas"]   = "qtdvagas";
   $tab_labels["qtdvagas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['labels']["qtdvagas"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['labels']["qtdvagas"] : "Qtd. de Vagas";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_tbl_turma_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_tbl_turma']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
