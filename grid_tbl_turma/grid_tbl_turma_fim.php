...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["ISchool_____grid_tbl_turma"]))
   {
      unset($_SESSION['session_sec_aplicacao']["ISchool_____grid_tbl_turma"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbl_turma'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_turma']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbl_turma']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_turma']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbl_turma']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbl_turma']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_turma']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbl_turma']['embutida_filho'] as $ind => $sc_init)
          {
