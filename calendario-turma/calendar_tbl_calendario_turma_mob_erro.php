...
$old_error_handler = set_error_handler("calendar_tbl_calendario_turma_mob_scriptcase_error_handler");

function calendar_tbl_calendario_turma_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['calendar_tbl_calendario_turma_mob']['contr_erro']) && $_SESSION['scriptcase']['calendar_tbl_calendario_turma_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_calendar_tbl_calendario_turma_mob->contr_calendar_tbl_calendario_turma_mob->Apl_com_erro = true;
            if ($inicial_calendar_tbl_calendario_turma_mob->contr_calendar_tbl_calendario_turma_mob->NM_ajax_flag)
            {
                $inicial_calendar_tbl_calendario_turma_mob->contr_calendar_tbl_calendario_turma_mob->NM_ajax_info['errList']['geral_calendar_tbl_calendario_turma_mob'][] = $msg;
                return;
            }
            calendar_tbl_calendario_turma_mob_scriptcase_error_display($msg, $err_no);
        }
...
function calendar_tbl_calendario_turma_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['calendar_tbl_calendario_turma_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['calendar_tbl_calendario_turma_mob'])  ? $_SESSION['scriptcase']['error_icon']['calendar_tbl_calendario_turma_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['calendar_tbl_calendario_turma_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['calendar_tbl_calendario_turma_mob']) ? $_SESSION['scriptcase']['error_span_title']['calendar_tbl_calendario_turma_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['calendar_tbl_calendario_turma_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['calendar_tbl_calendario_turma_mob']) ? $_SESSION['scriptcase']['error_icon_title']['calendar_tbl_calendario_turma_mob'] : '';
?>
