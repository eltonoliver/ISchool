<?php  
  session_start() ;
  class calendar_tbl_calendario_turma_form_teste
  {
   function calendar_tbl_calendario_turma_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "calendar_tbl_calendario_turma/img";
...
?> 
<br> 
<B><FONT SIZE="4">calendario-turma</FONT></B> 
<br> 
...
<input type="submit" value="calendario-turma"> 
</form> 
...
<?php
  ...
  $frm_teste = new calendar_tbl_calendario_turma_form_teste();
  $frm_teste->calendar_tbl_calendario_turma_teste();
?>
