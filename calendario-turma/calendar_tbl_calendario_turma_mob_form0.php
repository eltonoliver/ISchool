...
<?php
include_once("calendar_tbl_calendario_turma_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('calendar_tbl_calendario_turma_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['recarga'];
}
?>
...
<?php
 include_once("calendar_tbl_calendario_turma_mob_js0.php");
?>
...
<form name="F1" method="post" 
               action="calendar_tbl_calendario_turma_mob.php" 
               target="_self"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['calendar_tbl_calendario_turma_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['calendar_tbl_calendario_turma_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_title" style="<?php echo $sStyleHidden_title; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_title"><?php echo $this->nm_new_label['title']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['php_cmp_required']['title']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['php_cmp_required']['title'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_title_dumb = ('' == $sStyleHidden_title) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_title_dumb" style="<?php echo $sStyleHidden_title_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_start_date" style="<?php echo $sStyleHidden_start_date; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_start_date"><?php echo $this->nm_new_label['start_date']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['php_cmp_required']['start_date']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['php_cmp_required']['start_date'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_horarioinicial" style="<?php echo $sStyleHidden_horarioinicial; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_horarioinicial"><?php echo $this->nm_new_label['horarioinicial']; ?></span></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_horarioinicial_dumb = ('' == $sStyleHidden_horarioinicial) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_horarioinicial_dumb" style="<?php echo $sStyleHidden_horarioinicial_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_end_date" style="<?php echo $sStyleHidden_end_date; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_end_date"><?php echo $this->nm_new_label['end_date']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_horariofinal" style="<?php echo $sStyleHidden_horariofinal; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_horariofinal"><?php echo $this->nm_new_label['horariofinal']; ?></span></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_horariofinal_dumb = ('' == $sStyleHidden_horariofinal) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_horariofinal_dumb" style="<?php echo $sStyleHidden_horariofinal_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_recurrent" style="<?php echo $sStyleHidden_recurrent; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_recurrent"><?php echo $this->nm_new_label['recurrent']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['Lookup_recurrent'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['Lookup_recurrent'][] = 'N'; ?>
 </select></span>
</span><?php  }?>
...
<?php } 
?> 
<?php $sStyleHidden_recurrent_dumb = ('' == $sStyleHidden_recurrent) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_recurrent_dumb" style="<?php echo $sStyleHidden_recurrent_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_period" style="<?php echo $sStyleHidden_period; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_period"><?php echo $this->nm_new_label['period']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['Lookup_period'][] = 'D'; ?>
 <option value="W" <?php  if ($this->period == "W") { echo " selected" ;} ?>><?php echo $this->Ini->Nm_lang['lang_recu_weekly']; ?></option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['Lookup_period'][] = 'W'; ?>
 <option value="A" <?php  if ($this->period == "A") { echo " selected" ;} ?>><?php echo $this->Ini->Nm_lang['lang_recu_annual']; ?></option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['Lookup_period'][] = 'A'; ?>
 </select></span>
</span><?php  }?>
...
<?php } 
?> 
<?php $sStyleHidden_period_dumb = ('' == $sStyleHidden_period) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_period_dumb" style="<?php echo $sStyleHidden_period_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
   ...
   {
       $this->nm_new_label['__calend_all_day__'] = "__calend_all_day__";
   }
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
...
?> 
    ...
    <TD class="scFormDataOdd" id="hidden_field_data___calend_all_day__" style="<?php echo $sStyleHidden___calend_all_day__; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label___calend_all_day__"><?php echo $this->nm_new_label['__calend_all_day__']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['Lookup___calend_all_day__'][] = 'Y'; ?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_tbl_calendario_turma_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
<script>
 parent.scAjaxDetailStatus("calendar_tbl_calendario_turma_mob");
 parent.scAjaxDetailHeight("calendar_tbl_calendario_turma_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
