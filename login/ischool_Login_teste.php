<?php  
  session_start() ;
  class ischool_Login_form_teste
  {
   function ischool_Login_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "ischool_Login/img";
...
<?php
  ...
  $frm_teste = new ischool_Login_form_teste();
  $frm_teste->ischool_Login_teste();
?>
