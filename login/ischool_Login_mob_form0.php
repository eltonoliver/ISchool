...
<?php
include_once("ischool_Login_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('ischool_Login_mob_jquery.php');
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['ischool_Login_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['ischool_Login_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['ischool_Login_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['ischool_Login_mob']['recarga'];
}
?>
...
<?php
 include_once("ischool_Login_mob_js0.php");
?>
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['ischool_Login_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['ischool_Login_mob']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['ischool_Login_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['ischool_Login_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['ischool_Login_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['ischool_Login_mob']['empty_filter'] = true;
       }
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_logo" style="<?php echo $sStyleHidden_logo; ?>;"> <span class="scFormLabelOddFormat" style=";" ><span id="id_label_logo"><?php echo $this->nm_new_label['logo']; ?></span></span><br><?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_login" style="<?php echo $sStyleHidden_login; ?>;"> <span class="scFormLabelOddFormat" style=";" ><span id="id_label_login"><?php echo $this->nm_new_label['login']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ischool_Login_mob']['php_cmp_required']['login']) || $_SESSION['sc_session'][$this->Ini->sc_page]['ischool_Login_mob']['php_cmp_required']['login'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_pswd" style="<?php echo $sStyleHidden_pswd; ?>;"> <span class="scFormLabelOddFormat" style=";" ><span id="id_label_pswd"><?php echo $this->nm_new_label['pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ischool_Login_mob']['php_cmp_required']['pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['ischool_Login_mob']['php_cmp_required']['pswd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ischool_Login_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['ischool_Login_mob']['mostra_cab'] != "N"))
  {
?>
</td></tr> 
...
?>
<script>
 parent.scAjaxDetailStatus("ischool_Login_mob");
 parent.scAjaxDetailHeight("ischool_Login_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
