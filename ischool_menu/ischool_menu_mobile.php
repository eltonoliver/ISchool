...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["ischool_menu"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["ischool_menu"]["glo_nm_path_prod"]; ?>/third/jquery/js/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["ischool_menu"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    </head>
    <body>
   <TABLE width="100%" class="scMenuHHeader">
    ...
    <?php
        escreveMenuMobile($ischool_menu_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
