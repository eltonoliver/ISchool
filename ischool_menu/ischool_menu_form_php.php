...
class ischool_menu_form_php
{
   ...
   function init()
   {
      ...
      //check prod
      if(!isset($_SESSION['scriptcase']['ischool_menu']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['ischool_menu']['glo_nm_path_prod']))
      {
...
<?php
      ...
      $_SESSION['scriptcase']['ischool_menu']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['ischool_menu']['contr_erro'] = 'off';
      ...
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['ischool_menu'] as $id_item => $arr_item)
         {
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("ischool_grid_sec_users") . "/?nm_run_menu=1&nm_apl_menu=ischool_menu&script_case_init=1&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "ischool_grid_sec_apps")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("ischool_grid_sec_apps") . "/?nm_run_menu=1&nm_apl_menu=ischool_menu&script_case_init=1&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "ischool_grid_sec_groups")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("ischool_grid_sec_groups") . "/?nm_run_menu=1&nm_apl_menu=ischool_menu&script_case_init=1&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "ischool_search_sec_groups")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("ischool_search_sec_groups") . "/?nm_run_menu=1&nm_apl_menu=ischool_menu&script_case_init=1&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "ischool_sync_apps")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("ischool_sync_apps") . "/?nm_run_menu=1&nm_apl_menu=ischool_menu&script_case_init=1&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "ischool_change_pswd")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("ischool_change_pswd") . "/?nm_run_menu=1&nm_apl_menu=ischool_menu&script_case_init=1&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "ischool_Login")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("ischool_Login") . "/?script_case_init=" . $_SESSION['sc_session'][1]['ischool_menu']['init'] . "&script_case_session=" . session_id() . "";
      }
      }
      if (!$link_url)
      {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="ischool_menu"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "ischool_menu")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'ischool_menu', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
SC_dir_app_ini('ISchool');
$controle = new ischool_menu_form_php();
$controle->init();
?>
