...
class ischool_grid_sec_users_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function ischool_grid_sec_users_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".rtf";
      $this->tit_doc    = "ischool_grid_sec_users.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['ischool_grid_sec_users']['rtf_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['ischool_grid_sec_users']['rtf_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['ischool_grid_sec_users']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['ischool_grid_sec_users']['rtf_name']);
      }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['ischool_grid_sec_users']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['ischool_grid_sec_users']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
