<?php  
  session_start() ;
  class ischool_form_sec_apps_form_teste
  {
   function ischool_form_sec_apps_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "ischool_form_sec_apps/img";
...
?> 
<br> 
<B><FONT SIZE="4">ischool_form_sec_apps</FONT></B> 
<br> 
...
<input type="submit" value="ischool_form_sec_apps"> 
</form> 
...
<?php
  ...
  $frm_teste = new ischool_form_sec_apps_form_teste();
  $frm_teste->ischool_form_sec_apps_teste();
?>
