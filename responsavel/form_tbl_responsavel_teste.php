<?php  
  session_start() ;
  class form_tbl_responsavel_form_teste
  {
   function form_tbl_responsavel_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_tbl_responsavel/img";
...
?> 
<br> 
<B><FONT SIZE="4">responsavel</FONT></B> 
<br> 
<form name="Fedit" method="post" 
               action="index.php" 
               target="_self"> 
<input type="hidden" name="script_case_session" value="<?php echo session_id() ?>"/><input type="hidden" name="nmgp_outra_jan" value="true"/>id&nbsp;&nbsp;<input type="text" name="id" size=20><br> 
<input type="hidden" name="NM_contr_var_session" value="Yes"> 
<input type="submit" value="responsavel"> 
</form> 
<script language=javascript> 
 document.Fedit.id.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new form_tbl_responsavel_form_teste();
  $frm_teste->form_tbl_responsavel_teste();
?>
