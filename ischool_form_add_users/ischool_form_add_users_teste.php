<?php  
  session_start() ;
  class ischool_form_add_users_form_teste
  {
   function ischool_form_add_users_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "ischool_form_add_users/img";
...
?> 
<br> 
<B><FONT SIZE="4">ischool_form_add_users</FONT></B> 
<br> 
...
<input type="submit" value="ischool_form_add_users"> 
</form> 
...
<?php
  ...
  $frm_teste = new ischool_form_add_users_form_teste();
  $frm_teste->ischool_form_add_users_teste();
?>
