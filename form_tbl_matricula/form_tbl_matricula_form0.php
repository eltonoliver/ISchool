...
<?php
include_once("form_tbl_matricula_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbl_matricula_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['recarga'];
}
?>
...
<?php
 include_once("form_tbl_matricula_js0.php");
?>
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbl_matricula'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbl_matricula'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_turma" style="<?php echo $sStyleHidden_turma; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_turma"><?php echo $this->nm_new_label['turma']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['php_cmp_required']['turma']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['php_cmp_required']['turma'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_datamatricula" style="<?php echo $sStyleHidden_datamatricula; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_datamatricula"><?php echo $this->nm_new_label['datamatricula']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['php_cmp_required']['datamatricula']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['php_cmp_required']['datamatricula'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['Lookup_periodoletivo'][] = '1'; ?>
 <option value="2" <?php  if ($this->periodoletivo == "2") { echo " selected" ;} ?>>2014</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['Lookup_periodoletivo'][] = '2'; ?>
 <option value="3" <?php  if ($this->periodoletivo == "3") { echo " selected" ;} ?>>2015</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['Lookup_periodoletivo'][] = '3'; ?>
 <option value="4" <?php  if ($this->periodoletivo == "4") { echo " selected" ;} ?>>2016</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['Lookup_periodoletivo'][] = '4'; ?>
 <option value="5" <?php  if ($this->periodoletivo == "5") { echo " selected" ;} ?>>2017</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['Lookup_periodoletivo'][] = '5'; ?>
 <option value="6" <?php  if ($this->periodoletivo == "6") { echo " selected" ;} ?>>2018</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['Lookup_periodoletivo'][] = '6'; ?>
 <option value="7" <?php  if ($this->periodoletivo == "7") { echo " selected" ;} ?>>2019</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['Lookup_periodoletivo'][] = '7'; ?>
 <option value="8" <?php  if ($this->periodoletivo == "8") { echo " selected" ;} ?>>2020</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['Lookup_periodoletivo'][] = '8'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['Lookup_nivel'][] = '1'; ?>
 <option value="2" <?php  if ($this->nivel == "2") { echo " selected" ;} ?>>Intermediário</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['Lookup_nivel'][] = '2'; ?>
 <option value="3" <?php  if ($this->nivel == "3") { echo " selected" ;} ?>>Avaçado</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['Lookup_nivel'][] = '3'; ?>
 <option value="4" <?php  if ($this->nivel == "4") { echo " selected" ;} ?>>Profissionalizante</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['Lookup_nivel'][] = '4'; ?>
 <option value="5" <?php  if ($this->nivel == "5") { echo " selected" ;} ?>>Ensino Fundamental</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['Lookup_nivel'][] = '5'; ?>
 <option value="6" <?php  if ($this->nivel == "6") { echo " selected" ;} ?>>Ensino Médio</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['Lookup_nivel'][] = '6'; ?>
 <option value="7" <?php  if ($this->nivel == "7") { echo " selected" ;} ?>>Ensino Técnico</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['Lookup_nivel'][] = '7'; ?>
 <option value="8" <?php  if ($this->nivel == "8") { echo " selected" ;} ?>>Ensino Superior</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['Lookup_nivel'][] = '8'; ?>
 <option value="9" <?php  if ($this->nivel == "9") { echo " selected" ;} ?>>Cursos EAD</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['Lookup_nivel'][] = '9'; ?>
 <option value="10" <?php  if ($this->nivel == "10") { echo " selected" ;} ?>>Cursos Livres</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['Lookup_nivel'][] = '10'; ?>
 </select></span>
</span><?php  }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['total'] + 1)?>);</script><?php } ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_matricula']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
<?php
  }
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbl_matricula");
 parent.scAjaxDetailHeight("form_tbl_matricula", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
