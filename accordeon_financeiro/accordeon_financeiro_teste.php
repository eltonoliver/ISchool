<?php  
  include_once('accordeon_financeiro_session.php');
  session_start() ;
  class accordeon_financeiro_form_teste
  {
  function accordeon_financeiro_teste()
  {
...
<html> 
<HEAD>
 <title>accordeon_financeiro</title> 
...
<?php  
  ...
  if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'accordeon_financeiro')
  {
...
?> 
<br> 
<B><FONT SIZE="4">accordeon_financeiro</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="./" 
               target="_self"> 
idAlunoFin&nbsp;&nbsp;<input type=text name="idAlunoFin" size=20><br> 
<input type="hidden" name="script_case_session" value="<?php echo session_id() ?>"/>
<input type="hidden" name="nmgp_outra_jan" value="true"/>
<input type="hidden" name="nmgp_start" value="SC"/>
<input type=hidden name="NM_contr_var_session" value="Yes"> 
<input type=submit value="accordeon_financeiro"> 
</form> 
<script language=javascript> 
 document.FCons.idAlunoFin.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new accordeon_financeiro_form_teste();
  $frm_teste->accordeon_financeiro_teste();
?>
