...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['accordeon_financeiro']['contr_erro']) && $_SESSION['scriptcase']['accordeon_financeiro']['contr_erro'] == 'on')
    {
...
function scriptcase_error_display($err_msg, $err_no)
{
   ...
   {
       include_once("accordeon_financeiro_nmutf8.php");
   }
   $Nm_lang = array();
