<?php  
  session_start() ;
  class form_tbl_planpg_form_teste
  {
   function form_tbl_planpg_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_tbl_planpg/img";
...
?> 
<br> 
<B><FONT SIZE="4">plano-pagamento</FONT></B> 
<br> 
<form name="Fedit" method="post" 
               action="index.php" 
               target="_self"> 
<input type="hidden" name="script_case_session" value="<?php echo session_id() ?>"/><input type="hidden" name="nmgp_outra_jan" value="true"/>idAlunoFin&nbsp;&nbsp;<input type="text" name="idAlunoFin" size=20><br> 
<input type="hidden" name="NM_contr_var_session" value="Yes"> 
<input type="submit" value="plano-pagamento"> 
</form> 
<script language=javascript> 
 document.Fedit.idAlunoFin.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new form_tbl_planpg_form_teste();
  $frm_teste->form_tbl_planpg_teste();
?>
