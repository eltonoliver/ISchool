...
<?php
include_once("form_tbl_planpg_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbl_planpg_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['recarga'];
}
?>
...
<?php
 include_once("form_tbl_planpg_js0.php");
?>
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbl_planpg'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbl_planpg'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['fast_search'][2] : "";
?> 
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_id" style="<?php echo $sStyleHidden_id; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_eventofin" style="<?php echo $sStyleHidden_eventofin; ?>;"><span id="id_label_eventofin"><?php echo $this->nm_new_label['eventofin']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_eventofin" style="<?php echo $sStyleHidden_eventofin; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_eventofin'][] = ''; ?>
 <option value=""></option>
 <option value="1" <?php  if ($this->eventofin == "1") { echo " selected" ;} ?>>Receitas Mensalidades</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_eventofin'][] = '1'; ?>
 <option value="2" <?php  if ($this->eventofin == "2") { echo " selected" ;} ?>>Material Escolar</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_eventofin'][] = '2'; ?>
 <option value="3" <?php  if ($this->eventofin == "3") { echo " selected" ;} ?>>Matrícula</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_eventofin'][] = '3'; ?>
 <option value="4" <?php  if ($this->eventofin == "4") { echo " selected" ;} ?>>Juros</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_eventofin'][] = '4'; ?>
 <option value="5" <?php  if ($this->eventofin == "5") { echo " selected" ;} ?>>Multa</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_eventofin'][] = '5'; ?>
 <option value="6" <?php  if ($this->eventofin == "6") { echo " selected" ;} ?>>Prova de Reposição</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_eventofin'][] = '6'; ?>
 <option value="7" <?php  if ($this->eventofin == "7") { echo " selected" ;} ?>>Renegociação</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_eventofin'][] = '7'; ?>
 <option value="8" <?php  if ($this->eventofin == "8") { echo " selected" ;} ?>>Aula extra</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_eventofin'][] = '8'; ?>
 <option value="9" <?php  if ($this->eventofin == "9") { echo " selected" ;} ?>>Aula de Reposição</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_eventofin'][] = '9'; ?>
 <option value="10" <?php  if ($this->eventofin == "10") { echo " selected" ;} ?>>Eventos</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_eventofin'][] = '10'; ?>
 <option value="11" <?php  if ($this->eventofin == "11") { echo " selected" ;} ?>>Uniforme Escolar</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_eventofin'][] = '11'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_parcelamento" style="<?php echo $sStyleHidden_parcelamento; ?>;"><span id="id_label_parcelamento"><?php echo $this->nm_new_label['parcelamento']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_parcelamento" style="<?php echo $sStyleHidden_parcelamento; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_parcelamento'][] = ''; ?>
 <option value=""></option>
 <option value="1" <?php  if ($this->parcelamento == "1") { echo " selected" ;} ?>>À vista</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_parcelamento'][] = '1'; ?>
 <option value="2" <?php  if ($this->parcelamento == "2") { echo " selected" ;} ?>>2x</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_parcelamento'][] = '2'; ?>
 <option value="3" <?php  if ($this->parcelamento == "3") { echo " selected" ;} ?>>3x</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_parcelamento'][] = '3'; ?>
 <option value="4" <?php  if ($this->parcelamento == "4") { echo " selected" ;} ?>>4x</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_parcelamento'][] = '4'; ?>
 <option value="5" <?php  if ($this->parcelamento == "5") { echo " selected" ;} ?>>5x</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_parcelamento'][] = '5'; ?>
 <option value="6" <?php  if ($this->parcelamento == "6") { echo " selected" ;} ?>>6x</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_parcelamento'][] = '6'; ?>
 <option value="7" <?php  if ($this->parcelamento == "7") { echo " selected" ;} ?>>7x</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_parcelamento'][] = '7'; ?>
 <option value="8" <?php  if ($this->parcelamento == "8") { echo " selected" ;} ?>>8x</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_parcelamento'][] = '8'; ?>
 <option value="9" <?php  if ($this->parcelamento == "9") { echo " selected" ;} ?>>9x</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_parcelamento'][] = '9'; ?>
 <option value="10" <?php  if ($this->parcelamento == "10") { echo " selected" ;} ?>>10x</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_parcelamento'][] = '10'; ?>
 <option value="11" <?php  if ($this->parcelamento == "11") { echo " selected" ;} ?>>11x</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_parcelamento'][] = '11'; ?>
 <option value="12" <?php  if ($this->parcelamento == "12") { echo " selected" ;} ?>>12x</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_parcelamento'][] = '12'; ?>
 <option value="13" <?php  if ($this->parcelamento == "13") { echo " selected" ;} ?>>13x</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_parcelamento'][] = '13'; ?>
 <option value="14" <?php  if ($this->parcelamento == "14") { echo " selected" ;} ?>>14x</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_parcelamento'][] = '14'; ?>
 <option value="15" <?php  if ($this->parcelamento == "15") { echo " selected" ;} ?>>15x</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_parcelamento'][] = '15'; ?>
 <option value="16" <?php  if ($this->parcelamento == "16") { echo " selected" ;} ?>>16x</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_parcelamento'][] = '16'; ?>
 <option value="17" <?php  if ($this->parcelamento == "17") { echo " selected" ;} ?>>17x</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_parcelamento'][] = '17'; ?>
 <option value="18" <?php  if ($this->parcelamento == "18") { echo " selected" ;} ?>>18x</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_parcelamento'][] = '18'; ?>
 <option value="19" <?php  if ($this->parcelamento == "19") { echo " selected" ;} ?>>19x</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_parcelamento'][] = '19'; ?>
 <option value="20" <?php  if ($this->parcelamento == "20") { echo " selected" ;} ?>>20x</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_parcelamento'][] = '20'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_periodicidade" style="<?php echo $sStyleHidden_periodicidade; ?>;"><span id="id_label_periodicidade"><?php echo $this->nm_new_label['periodicidade']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_periodicidade" style="<?php echo $sStyleHidden_periodicidade; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_periodicidade'][] = ''; ?>
 <option value=""></option>
 <option value="1" <?php  if ($this->periodicidade == "1") { echo " selected" ;} ?>>Mensal</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_periodicidade'][] = '1'; ?>
 <option value="2" <?php  if ($this->periodicidade == "2") { echo " selected" ;} ?>>Bimestral</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_periodicidade'][] = '2'; ?>
 <option value="3" <?php  if ($this->periodicidade == "3") { echo " selected" ;} ?>>Trimestral</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_periodicidade'][] = '3'; ?>
 <option value="4" <?php  if ($this->periodicidade == "4") { echo " selected" ;} ?>>Semestral</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_periodicidade'][] = '4'; ?>
 <option value="5" <?php  if ($this->periodicidade == "5") { echo " selected" ;} ?>>Anual</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_periodicidade'][] = '5'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_formapg" style="<?php echo $sStyleHidden_formapg; ?>;"><span id="id_label_formapg"><?php echo $this->nm_new_label['formapg']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_formapg" style="<?php echo $sStyleHidden_formapg; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_formapg'][] = ''; ?>
 <option value=""></option>
 <option value="1" <?php  if ($this->formapg == "1") { echo " selected" ;} ?>>Dinheiro</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_formapg'][] = '1'; ?>
 <option value="2" <?php  if ($this->formapg == "2") { echo " selected" ;} ?>>Cheque</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_formapg'][] = '2'; ?>
 <option value="3" <?php  if ($this->formapg == "3") { echo " selected" ;} ?>>Cartão</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_formapg'][] = '3'; ?>
 <option value="4" <?php  if ($this->formapg == "4") { echo " selected" ;} ?>>Débito automático</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_formapg'][] = '4'; ?>
 <option value="5" <?php  if ($this->formapg == "5") { echo " selected" ;} ?>>Tranferência</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_formapg'][] = '5'; ?>
 <option value="6" <?php  if ($this->formapg == "6") { echo " selected" ;} ?>>TED</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_formapg'][] = '6'; ?>
 <option value="7" <?php  if ($this->formapg == "7") { echo " selected" ;} ?>>Cobrança Bancária</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_formapg'][] = '7'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_dataparcela" style="<?php echo $sStyleHidden_dataparcela; ?>;"><span id="id_label_dataparcela"><?php echo $this->nm_new_label['dataparcela']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['php_cmp_required']['dataparcela']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['php_cmp_required']['dataparcela'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_dataparcela" style="<?php echo $sStyleHidden_dataparcela; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_bolsa" style="<?php echo $sStyleHidden_bolsa; ?>;"><span id="id_label_bolsa"><?php echo $this->nm_new_label['bolsa']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_bolsa" style="<?php echo $sStyleHidden_bolsa; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_bolsa'][] = ''; ?>
 <option value=""></option>
 <option value="1" <?php  if ($this->bolsa == "1") { echo " selected" ;} ?>>10%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_bolsa'][] = '1'; ?>
 <option value="2" <?php  if ($this->bolsa == "2") { echo " selected" ;} ?>>20%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_bolsa'][] = '2'; ?>
 <option value="3" <?php  if ($this->bolsa == "3") { echo " selected" ;} ?>>50%</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_bolsa'][] = '3'; ?>
 <option value="4" <?php  if ($this->bolsa == "4") { echo " selected" ;} ?>>Projeto Cetebras</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_bolsa'][] = '4'; ?>
 <option value="5" <?php  if ($this->bolsa == "5") { echo " selected" ;} ?>>Integral</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_bolsa'][] = '5'; ?>
 <option value="6" <?php  if ($this->bolsa == "6") { echo " selected" ;} ?>>Bolsa parceria</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['Lookup_bolsa'][] = '6'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_valparcela" style="<?php echo $sStyleHidden_valparcela; ?>;"><span id="id_label_valparcela"><?php echo $this->nm_new_label['valparcela']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_valparcela" style="<?php echo $sStyleHidden_valparcela; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_valdesconto" style="<?php echo $sStyleHidden_valdesconto; ?>;"><span id="id_label_valdesconto"><?php echo $this->nm_new_label['valdesconto']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_valdesconto" style="<?php echo $sStyleHidden_valdesconto; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['total'] + 1)?>);</script><?php } ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_planpg']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
<?php
  }
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbl_planpg");
 parent.scAjaxDetailHeight("form_tbl_planpg", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
