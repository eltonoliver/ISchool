...
<?php
include_once("form_tbl_aluno_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbl_aluno_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['recarga'];
}
?>
...
<?php
 include_once("form_tbl_aluno_js0.php");
?>
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbl_aluno'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbl_aluno'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_nome" style="<?php echo $sStyleHidden_nome; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_nome"><?php echo $this->nm_new_label['nome']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['php_cmp_required']['nome']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['php_cmp_required']['nome'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['Lookup_sexo'][] = '1'; ?>
 <option value="2" <?php  if ($this->sexo == "2") { echo " selected" ;} ?>>Feminino</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['Lookup_sexo'][] = '2'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['Lookup_estadocivil'][] = '1'; ?>
 <option value="2" <?php  if ($this->estadocivil == "2") { echo " selected" ;} ?>>Casado</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['Lookup_estadocivil'][] = '2'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_estados_id_nasc" style="<?php echo $sStyleHidden_estados_id_nasc; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_estados_id_nasc"><?php echo $this->nm_new_label['estados_id_nasc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['php_cmp_required']['estados_id_nasc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['php_cmp_required']['estados_id_nasc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['Lookup_formaingresso'][] = '1'; ?>
 <option value="2" <?php  if ($this->formaingresso == "2") { echo " selected" ;} ?>>Gratuíto</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['Lookup_formaingresso'][] = '2'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_senha" style="<?php echo $sStyleHidden_senha; ?>;"><span id="id_label_senha"><?php echo $this->nm_new_label['senha']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_senha" style="<?php echo $sStyleHidden_senha; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_nomemae" style="<?php echo $sStyleHidden_nomemae; ?>;"><span id="id_label_nomemae"><?php echo $this->nm_new_label['nomemae']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_nomemae" style="<?php echo $sStyleHidden_nomemae; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_nomepai" style="<?php echo $sStyleHidden_nomepai; ?>;"><span id="id_label_nomepai"><?php echo $this->nm_new_label['nomepai']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_nomepai" style="<?php echo $sStyleHidden_nomepai; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_numerocel" style="<?php echo $sStyleHidden_numerocel; ?>;"><span id="id_label_numerocel"><?php echo $this->nm_new_label['numerocel']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_numerocel" style="<?php echo $sStyleHidden_numerocel; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_numerotel" style="<?php echo $sStyleHidden_numerotel; ?>;"><span id="id_label_numerotel"><?php echo $this->nm_new_label['numerotel']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_numerotel" style="<?php echo $sStyleHidden_numerotel; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_numeroprof" style="<?php echo $sStyleHidden_numeroprof; ?>;"><span id="id_label_numeroprof"><?php echo $this->nm_new_label['numeroprof']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_numeroprof" style="<?php echo $sStyleHidden_numeroprof; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_emailpessoal" style="<?php echo $sStyleHidden_emailpessoal; ?>;"><span id="id_label_emailpessoal"><?php echo $this->nm_new_label['emailpessoal']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_emailpessoal" style="<?php echo $sStyleHidden_emailpessoal; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_emailprofissional" style="<?php echo $sStyleHidden_emailprofissional; ?>;"><span id="id_label_emailprofissional"><?php echo $this->nm_new_label['emailprofissional']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_emailprofissional" style="<?php echo $sStyleHidden_emailprofissional; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_cep" style="<?php echo $sStyleHidden_cep; ?>;"><span id="id_label_cep"><?php echo $this->nm_new_label['cep']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_cep" style="<?php echo $sStyleHidden_cep; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_logradouro" style="<?php echo $sStyleHidden_logradouro; ?>;"><span id="id_label_logradouro"><?php echo $this->nm_new_label['logradouro']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_logradouro" style="<?php echo $sStyleHidden_logradouro; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_numero" style="<?php echo $sStyleHidden_numero; ?>;"><span id="id_label_numero"><?php echo $this->nm_new_label['numero']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_numero" style="<?php echo $sStyleHidden_numero; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_complemento" style="<?php echo $sStyleHidden_complemento; ?>;"><span id="id_label_complemento"><?php echo $this->nm_new_label['complemento']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_complemento" style="<?php echo $sStyleHidden_complemento; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_estados_id_res" style="<?php echo $sStyleHidden_estados_id_res; ?>;"><span id="id_label_estados_id_res"><?php echo $this->nm_new_label['estados_id_res']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_estados_id_res" style="<?php echo $sStyleHidden_estados_id_res; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_cidades_id_res" style="<?php echo $sStyleHidden_cidades_id_res; ?>;"><span id="id_label_cidades_id_res"><?php echo $this->nm_new_label['cidades_id_res']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_cidades_id_res" style="<?php echo $sStyleHidden_cidades_id_res; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_observacao" style="<?php echo $sStyleHidden_observacao; ?>;"><span id="id_label_observacao"><?php echo $this->nm_new_label['observacao']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_observacao" style="<?php echo $sStyleHidden_observacao; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_anexos" style="<?php echo $sStyleHidden_anexos; ?>;"><span id="id_label_anexos"><?php echo $this->nm_new_label['anexos']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_anexos" style="<?php echo $sStyleHidden_anexos; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['total'] + 1)?>);</script><?php } ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_aluno']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
<?php
  }
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbl_aluno");
 parent.scAjaxDetailHeight("form_tbl_aluno", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
