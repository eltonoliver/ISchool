  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbl_disciplina" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_
  function do_ajax_form_tbl_disciplina_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_disciplina_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbl_disciplina_validate_id__cb);
  } // do_ajax_form_tbl_disciplina_validate_id_

  function do_ajax_form_tbl_disciplina_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_disciplina_validate_id__cb

  // ---------- Validate nome_
  function do_ajax_form_tbl_disciplina_validate_nome_(iNumLinha)
  {
    var nomeCampo_nome_ = "nome_" + iNumLinha;
    var var_nome_ = scAjaxGetFieldText(nomeCampo_nome_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_disciplina_validate_nome_(var_nome_, iNumLinha, var_script_case_init, do_ajax_form_tbl_disciplina_validate_nome__cb);
  } // do_ajax_form_tbl_disciplina_validate_nome_

  function do_ajax_form_tbl_disciplina_validate_nome__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_disciplina_validate_nome__cb

  // ---------- Validate cargahoraria_
  function do_ajax_form_tbl_disciplina_validate_cargahoraria_(iNumLinha)
  {
    var nomeCampo_cargahoraria_ = "cargahoraria_" + iNumLinha;
    var var_cargahoraria_ = scAjaxGetFieldText(nomeCampo_cargahoraria_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_disciplina_validate_cargahoraria_(var_cargahoraria_, iNumLinha, var_script_case_init, do_ajax_form_tbl_disciplina_validate_cargahoraria__cb);
  } // do_ajax_form_tbl_disciplina_validate_cargahoraria_

  function do_ajax_form_tbl_disciplina_validate_cargahoraria__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cargahoraria_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cargahoraria_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cargahoraria_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cargahoraria_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_disciplina_validate_cargahoraria__cb

  // ---------- Validate periodoletivo_
  function do_ajax_form_tbl_disciplina_validate_periodoletivo_(iNumLinha)
  {
    var nomeCampo_periodoletivo_ = "periodoletivo_" + iNumLinha;
    var var_periodoletivo_ = scAjaxGetFieldSelect(nomeCampo_periodoletivo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_disciplina_validate_periodoletivo_(var_periodoletivo_, iNumLinha, var_script_case_init, do_ajax_form_tbl_disciplina_validate_periodoletivo__cb);
  } // do_ajax_form_tbl_disciplina_validate_periodoletivo_

  function do_ajax_form_tbl_disciplina_validate_periodoletivo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "periodoletivo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "periodoletivo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "periodoletivo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "periodoletivo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_disciplina_validate_periodoletivo__cb

  // ---------- Validate periodo_
  function do_ajax_form_tbl_disciplina_validate_periodo_(iNumLinha)
  {
    var nomeCampo_periodo_ = "periodo_" + iNumLinha;
    var var_periodo_ = scAjaxGetFieldSelect(nomeCampo_periodo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_disciplina_validate_periodo_(var_periodo_, iNumLinha, var_script_case_init, do_ajax_form_tbl_disciplina_validate_periodo__cb);
  } // do_ajax_form_tbl_disciplina_validate_periodo_

  function do_ajax_form_tbl_disciplina_validate_periodo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "periodo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "periodo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "periodo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "periodo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_disciplina_validate_periodo__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbl_disciplina_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbl_disciplina_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbl_disciplina_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbl_disciplina_add_new_line_cb);
  } // do_ajax_form_tbl_disciplina_add_new_line

  function do_ajax_form_tbl_disciplina_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_tbl_disciplina_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbl_disciplina_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_disciplina_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbl_disciplina_backup_line_cb);
  } // do_ajax_form_tbl_disciplina_backup_line

  function do_ajax_form_tbl_disciplina_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_tbl_disciplina_backup_line_cb

  function do_ajax_form_tbl_disciplina_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbl_disciplina_cancel_insert

  function do_ajax_form_tbl_disciplina_cancel_update(iSeqVert)
  {
    do_ajax_form_tbl_disciplina_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbl_disciplina_cancel_update

  function do_ajax_form_tbl_disciplina_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbl_disciplina_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbl_disciplina_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tbl_disciplina_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbl_disciplina_table_refresh_cb);
  } //  do_ajax_form_tbl_disciplina_table_refresh

  function do_ajax_form_tbl_disciplina_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbl_disciplina_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbl_disciplina_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbl_disciplina_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_cargahoraria_ = scAjaxGetFieldText("cargahoraria_" + iNumLinha);
    var var_periodoletivo_ = scAjaxGetFieldSelect("periodoletivo_" + iNumLinha);
    var var_periodo_ = scAjaxGetFieldSelect("periodo_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbl_disciplina_submit_form(var_id_, var_nome_, var_cargahoraria_, var_periodoletivo_, var_periodo_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_tbl_disciplina_submit_form_cb);
  } // do_ajax_form_tbl_disciplina_submit_form

  function do_ajax_form_tbl_disciplina_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("cargahoraria_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("periodoletivo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("periodo_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_form_tbl_disciplina_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tbl_disciplina_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbl_disciplina_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("cargahoraria_" + iNavForm);
      scAjaxHideErrorDisplay("periodoletivo_" + iNavForm);
      scAjaxHideErrorDisplay("periodo_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbl_disciplina_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbl_disciplina_navigate_form_cb);
  } // do_ajax_form_tbl_disciplina_navigate_form

  function do_ajax_form_tbl_disciplina_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
...
?>
  ...
  } // do_ajax_form_tbl_disciplina_navigate_form_cb
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cargahoraria_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "periodoletivo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "periodo_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_" + iNumLinha] = {"label": "Código<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["cargahoraria_" + iNumLinha] = {"label": "Carga Horária<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["periodoletivo_" + iNumLinha] = {"label": "Período Letivo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["periodo_" + iNumLinha] = {"label": "Período<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_mult["nome_"][iNumLinha] = "nome_" + iNumLinha;
    ajax_field_mult["cargahoraria_"][iNumLinha] = "cargahoraria_" + iNumLinha;
    ajax_field_mult["periodoletivo_"][iNumLinha] = "periodoletivo_" + iNumLinha;
    ajax_field_mult["periodo_"][iNumLinha] = "periodo_" + iNumLinha;
    ...
    ajax_field_id["cargahoraria_" + iNumLinha] = new Array("hidden_field_label_cargahoraria_", "hidden_field_data_cargahoraria_" + iNumLinha);
    ajax_field_id["periodoletivo_" + iNumLinha] = new Array("hidden_field_label_periodoletivo_", "hidden_field_data_periodoletivo_" + iNumLinha);
    ajax_field_id["periodo_" + iNumLinha] = new Array("hidden_field_label_periodo_", "hidden_field_data_periodo_" + iNumLinha);
    ajax_error_count["id_" + iNumLinha] = "off";
    ajax_error_count["nome_" + iNumLinha] = "off";
    ajax_error_count["cargahoraria_" + iNumLinha] = "off";
    ajax_error_count["periodoletivo_" + iNumLinha] = "off";
    ajax_error_count["periodo_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["nome_" + iNumLinha] = "off";
    ajax_read_only["cargahoraria_" + iNumLinha] = "off";
    ajax_read_only["periodoletivo_" + iNumLinha] = "off";
    ajax_read_only["periodo_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["cargahoraria_" + iNumLinha] = "on";
    ajax_read_only["periodoletivo_" + iNumLinha] = "on";
    ajax_read_only["periodo_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["cargahoraria_" + iNumLinha] = null;
    ajax_error_list["periodoletivo_" + iNumLinha] = null;
    ajax_error_list["periodo_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "id_": new Array(),
    "nome_": new Array(),
    "cargahoraria_": new Array(),
    "periodoletivo_": new Array(),
    "periodo_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["cargahoraria_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cargahoraria_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cargahoraria_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cargahoraria_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cargahoraria_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["periodoletivo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["periodoletivo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["periodoletivo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["periodoletivo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["periodoletivo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["periodo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["periodo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["periodo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["periodo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["periodo_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['nome_'])) ? $this->nmgp_cmp_readonly['nome_'] : 'off';
?>
    scAjaxFieldRead("nome_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cargahoraria_'])) ? $this->nmgp_cmp_readonly['cargahoraria_'] : 'off';
?>
    scAjaxFieldRead("cargahoraria_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['periodoletivo_'])) ? $this->nmgp_cmp_readonly['periodoletivo_'] : 'off';
?>
    scAjaxFieldRead("periodoletivo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['periodo_'])) ? $this->nmgp_cmp_readonly['periodo_'] : 'off';
?>
    scAjaxFieldRead("periodo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("cargahoraria_" + iSeq, "on");
    scAjaxFieldRead("periodoletivo_" + iSeq, "on");
    scAjaxFieldRead("periodo_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["nome_" + iRow] || "on" == ajax_error_count["cargahoraria_" + iRow] || "on" == ajax_error_count["periodoletivo_" + iRow] || "on" == ajax_error_count["periodo_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_nome_" + iRow))
        document.getElementById("hidden_field_data_nome_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_cargahoraria_" + iRow))
        document.getElementById("hidden_field_data_cargahoraria_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_periodoletivo_" + iRow))
        document.getElementById("hidden_field_data_periodoletivo_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_periodo_" + iRow))
        document.getElementById("hidden_field_data_periodo_" + iRow).className = "scFormErrorLine";
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["nome_" + iRow] && "off" == ajax_error_count["cargahoraria_" + iRow] && "off" == ajax_error_count["periodoletivo_" + iRow] && "off" == ajax_error_count["periodo_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["nome_" + iRow] = "off";
        ajax_error_count["cargahoraria_" + iRow] = "off";
        ajax_error_count["periodoletivo_" + iRow] = "off";
        ajax_error_count["periodo_" + iRow] = "off";
      }
      ...
      if (document.getElementById("hidden_field_data_nome_" + iRow))
        document.getElementById("hidden_field_data_nome_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_cargahoraria_" + iRow))
        document.getElementById("hidden_field_data_cargahoraria_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_periodoletivo_" + iRow))
        document.getElementById("hidden_field_data_periodoletivo_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_periodo_" + iRow))
        document.getElementById("hidden_field_data_periodo_" + iRow).className = sCssLine;
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("cargahoraria_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
    }
    if ("periodoletivo_" == sIndex)
    {
