<?php  
  session_start() ;
  class form_tbl_disciplina_form_teste
  {
   function form_tbl_disciplina_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_tbl_disciplina/img";
...
<?php
  ...
  $frm_teste = new form_tbl_disciplina_form_teste();
  $frm_teste->form_tbl_disciplina_teste();
?>
