<?php  
  session_start() ;
  class ischool_retrieve_pswd_form_teste
  {
   function ischool_retrieve_pswd_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "ischool_retrieve_pswd/img";
...
?> 
<br> 
<B><FONT SIZE="4">ischool_retrieve_pswd</FONT></B> 
<br> 
...
<input type="submit" value="ischool_retrieve_pswd"> 
</form> 
...
<?php
  ...
  $frm_teste = new ischool_retrieve_pswd_form_teste();
  $frm_teste->ischool_retrieve_pswd_teste();
?>
