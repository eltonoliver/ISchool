  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbl_curso_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id
  function do_ajax_form_tbl_curso_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_curso_mob_validate_id(var_id, var_script_case_init, do_ajax_form_tbl_curso_mob_validate_id_cb);
  } // do_ajax_form_tbl_curso_mob_validate_id

  function do_ajax_form_tbl_curso_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_curso_mob_validate_id_cb

  // ---------- Validate nome
  function do_ajax_form_tbl_curso_mob_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_curso_mob_validate_nome(var_nome, var_script_case_init, do_ajax_form_tbl_curso_mob_validate_nome_cb);
  } // do_ajax_form_tbl_curso_mob_validate_nome

  function do_ajax_form_tbl_curso_mob_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nome";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_curso_mob_validate_nome_cb

  // ---------- Validate horastot
  function do_ajax_form_tbl_curso_mob_validate_horastot()
  {
    var nomeCampo_horastot = "horastot";
    var var_horastot = scAjaxGetFieldText(nomeCampo_horastot);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_curso_mob_validate_horastot(var_horastot, var_script_case_init, do_ajax_form_tbl_curso_mob_validate_horastot_cb);
  } // do_ajax_form_tbl_curso_mob_validate_horastot

  function do_ajax_form_tbl_curso_mob_validate_horastot_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_curso_mob_validate_horastot_cb

  // ---------- Validate nivel
  function do_ajax_form_tbl_curso_mob_validate_nivel()
  {
    var nomeCampo_nivel = "nivel";
    var var_nivel = scAjaxGetFieldText(nomeCampo_nivel);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_curso_mob_validate_nivel(var_nivel, var_script_case_init, do_ajax_form_tbl_curso_mob_validate_nivel_cb);
  } // do_ajax_form_tbl_curso_mob_validate_nivel

  function do_ajax_form_tbl_curso_mob_validate_nivel_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nivel";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_curso_mob_validate_nivel_cb

  // ---------- Validate disciplinascurso
  function do_ajax_form_tbl_curso_mob_validate_disciplinascurso()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_curso_mob_validate_disciplinascurso(var_disciplinascurso, var_script_case_init, do_ajax_form_tbl_curso_mob_validate_disciplinascurso_cb);
  } // do_ajax_form_tbl_curso_mob_validate_disciplinascurso

  function do_ajax_form_tbl_curso_mob_validate_disciplinascurso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_curso_mob_validate_disciplinascurso_cb
  // ---------- Form
  function do_ajax_form_tbl_curso_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbl_curso_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbl_curso_mob_submit_form(var_id, var_nome, var_horastot, var_nivel, var_disciplinascurso, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_tbl_curso_mob_submit_form_cb);
  } // do_ajax_form_tbl_curso_mob_submit_form

  function do_ajax_form_tbl_curso_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbl_curso_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tbl_curso_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbl_curso_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbl_curso_mob_navigate_form_cb);
  } // do_ajax_form_tbl_curso_mob_navigate_form

  function do_ajax_form_tbl_curso_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_tbl_curso_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbl_curso_mob_navigate_form_cb
