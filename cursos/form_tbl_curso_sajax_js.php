  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbl_curso" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id
  function do_ajax_form_tbl_curso_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_curso_validate_id(var_id, var_script_case_init, do_ajax_form_tbl_curso_validate_id_cb);
  } // do_ajax_form_tbl_curso_validate_id

  function do_ajax_form_tbl_curso_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_curso_validate_id_cb

  // ---------- Validate nome
  function do_ajax_form_tbl_curso_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_curso_validate_nome(var_nome, var_script_case_init, do_ajax_form_tbl_curso_validate_nome_cb);
  } // do_ajax_form_tbl_curso_validate_nome

  function do_ajax_form_tbl_curso_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nome";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_curso_validate_nome_cb

  // ---------- Validate horastot
  function do_ajax_form_tbl_curso_validate_horastot()
  {
    var nomeCampo_horastot = "horastot";
    var var_horastot = scAjaxGetFieldText(nomeCampo_horastot);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_curso_validate_horastot(var_horastot, var_script_case_init, do_ajax_form_tbl_curso_validate_horastot_cb);
  } // do_ajax_form_tbl_curso_validate_horastot

  function do_ajax_form_tbl_curso_validate_horastot_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "horastot";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_curso_validate_horastot_cb

  // ---------- Validate nivel
  function do_ajax_form_tbl_curso_validate_nivel()
  {
    var nomeCampo_nivel = "nivel";
    var var_nivel = scAjaxGetFieldText(nomeCampo_nivel);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_curso_validate_nivel(var_nivel, var_script_case_init, do_ajax_form_tbl_curso_validate_nivel_cb);
  } // do_ajax_form_tbl_curso_validate_nivel

  function do_ajax_form_tbl_curso_validate_nivel_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nivel";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_curso_validate_nivel_cb

  // ---------- Validate disciplinascurso
  function do_ajax_form_tbl_curso_validate_disciplinascurso()
  {
    var nomeCampo_disciplinascurso = "disciplinascurso";
    nm_pack(nomeCampo_disciplinascurso + '_dest', nomeCampo_disciplinascurso);
    var var_disciplinascurso = scAjaxGetFieldText(nomeCampo_disciplinascurso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_curso_validate_disciplinascurso(var_disciplinascurso, var_script_case_init, do_ajax_form_tbl_curso_validate_disciplinascurso_cb);
  } // do_ajax_form_tbl_curso_validate_disciplinascurso

  function do_ajax_form_tbl_curso_validate_disciplinascurso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "disciplinascurso";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_curso_validate_disciplinascurso_cb
  // ---------- Form
  function do_ajax_form_tbl_curso_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbl_curso_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_nome = scAjaxGetFieldText("nome");
    var var_horastot = scAjaxGetFieldText("horastot");
    var var_nivel = scAjaxGetFieldText("nivel");
    nm_pack("disciplinascurso_dest", "disciplinascurso");
    var var_disciplinascurso = scAjaxGetFieldText("disciplinascurso", "@?@");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbl_curso_submit_form(var_id, var_nome, var_horastot, var_nivel, var_disciplinascurso, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_tbl_curso_submit_form_cb);
  } // do_ajax_form_tbl_curso_submit_form

  function do_ajax_form_tbl_curso_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("horastot");
      scAjaxHideErrorDisplay("nivel");
      scAjaxHideErrorDisplay("disciplinascurso");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_tbl_curso_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tbl_curso_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbl_curso_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbl_curso_navigate_form_cb);
  } // do_ajax_form_tbl_curso_navigate_form

  function do_ajax_form_tbl_curso_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_tbl_curso_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbl_curso_navigate_form_cb
  ...
  ajax_field_list[2] = "horastot";
  ajax_field_list[3] = "nivel";
  ajax_field_list[4] = "disciplinascurso";
  ...
  var ajax_error_list = {
    ...
    "horastot": {"label": "Horas Totais", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nivel": {"label": "Nível", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "disciplinascurso": {"label": "Disciplinas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "horastot": new Array(),
    "nivel": new Array(),
    "disciplinascurso": new Array()
  };
  ajax_field_mult["id"][1] = "id";
  ajax_field_mult["nome"][1] = "nome";
  ajax_field_mult["horastot"][1] = "horastot";
  ajax_field_mult["nivel"][1] = "nivel";
  ajax_field_mult["disciplinascurso"][1] = "disciplinascurso";

  var ajax_field_id = {
    "id": new Array("hidden_field_label_id", "hidden_field_data_id"),
    "nome": new Array("hidden_field_label_nome", "hidden_field_data_nome"),
    "horastot": new Array("hidden_field_label_horastot", "hidden_field_data_horastot"),
    "nivel": new Array("hidden_field_label_nivel", "hidden_field_data_nivel"),
    "disciplinascurso": new Array("hidden_field_label_disciplinascurso", "hidden_field_data_disciplinascurso")
  };
