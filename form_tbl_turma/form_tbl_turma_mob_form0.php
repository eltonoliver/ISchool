...
<?php
include_once("form_tbl_turma_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbl_turma_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['recarga'];
}
?>
...
<?php
 include_once("form_tbl_turma_mob_js0.php");
?>
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbl_turma_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbl_turma_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
<?php $sStyleHidden_diassemana_dumb = ('' == $sStyleHidden_diassemana) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_diassemana_dumb" style="<?php echo $sStyleHidden_diassemana_dumb; ?>"></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_nivel'][] = '1'; ?>
 <option value="2" <?php  if ($this->nivel == "2") { echo " selected" ;} ?>>Intermediário</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_nivel'][] = '2'; ?>
 <option value="3" <?php  if ($this->nivel == "3") { echo " selected" ;} ?>>Avançado</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_nivel'][] = '3'; ?>
 <option value="4" <?php  if ($this->nivel == "4") { echo " selected" ;} ?>>Ensino Fundamental</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_nivel'][] = '4'; ?>
 <option value="5" <?php  if ($this->nivel == "5") { echo " selected" ;} ?>>Ensino Médio</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_nivel'][] = '5'; ?>
 <option value="6" <?php  if ($this->nivel == "6") { echo " selected" ;} ?>>Ensino Técnico</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_nivel'][] = '6'; ?>
 <option value="7" <?php  if ($this->nivel == "7") { echo " selected" ;} ?>>Ensino Superior</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_nivel'][] = '7'; ?>
 <option value="8" <?php  if ($this->nivel == "8") { echo " selected" ;} ?>>Cursos Livres</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_nivel'][] = '8'; ?>
 <option value="9" <?php  if ($this->nivel == "9") { echo " selected" ;} ?>>Curso EAD</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_nivel'][] = '9'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_periodoletivo'][] = '1'; ?>
 <option value="2" <?php  if ($this->periodoletivo == "2") { echo " selected" ;} ?>>2014</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_periodoletivo'][] = '2'; ?>
 <option value="3" <?php  if ($this->periodoletivo == "3") { echo " selected" ;} ?>>2015</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_periodoletivo'][] = '3'; ?>
 <option value="4" <?php  if ($this->periodoletivo == "4") { echo " selected" ;} ?>>2016</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_periodoletivo'][] = '4'; ?>
 <option value="5" <?php  if ($this->periodoletivo == "5") { echo " selected" ;} ?>>2017</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_periodoletivo'][] = '5'; ?>
 <option value="6" <?php  if ($this->periodoletivo == "6") { echo " selected" ;} ?>>2018</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_periodoletivo'][] = '6'; ?>
 <option value="7" <?php  if ($this->periodoletivo == "7") { echo " selected" ;} ?>>2019</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_periodoletivo'][] = '7'; ?>
 <option value="8" <?php  if ($this->periodoletivo == "8") { echo " selected" ;} ?>>2020</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_periodoletivo'][] = '8'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_turno'][] = '1'; ?>
 <option value="2" <?php  if ($this->turno == "2") { echo " selected" ;} ?>>Tarde</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_turno'][] = '2'; ?>
 <option value="3" <?php  if ($this->turno == "3") { echo " selected" ;} ?>>Noite</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_turno'][] = '3'; ?>
 <option value="4" <?php  if ($this->turno == "4") { echo " selected" ;} ?>>Integral</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_turno'][] = '4'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_datainicio" style="<?php echo $sStyleHidden_datainicio; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_datainicio"><?php echo $this->nm_new_label['datainicio']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['php_cmp_required']['datainicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['php_cmp_required']['datainicio'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_datafim" style="<?php echo $sStyleHidden_datafim; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_datafim"><?php echo $this->nm_new_label['datafim']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['php_cmp_required']['datafim']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['php_cmp_required']['datafim'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_datafimmatricula" style="<?php echo $sStyleHidden_datafimmatricula; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_datafimmatricula"><?php echo $this->nm_new_label['datafimmatricula']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['php_cmp_required']['datafimmatricula']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['php_cmp_required']['datafimmatricula'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_horaentrada" style="<?php echo $sStyleHidden_horaentrada; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_horaentrada"><?php echo $this->nm_new_label['horaentrada']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['php_cmp_required']['horaentrada']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['php_cmp_required']['horaentrada'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_horasaida" style="<?php echo $sStyleHidden_horasaida; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_horasaida"><?php echo $this->nm_new_label['horasaida']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['php_cmp_required']['horasaida']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['php_cmp_required']['horasaida'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_diassemana'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_diassemana'][] = '2'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_diassemana'][] = '3'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_diassemana'][] = '4'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_diassemana'][] = '5'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['Lookup_diassemana'][] = '6'; ?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_turma_mob']['total'] + 1)?>);</script><?php } ?>
</td></tr> 
<?php
  }
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbl_turma_mob");
 parent.scAjaxDetailHeight("form_tbl_turma_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
