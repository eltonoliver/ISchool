<?php  
  session_start() ;
  class form_tbl_turma_form_teste
  {
   function form_tbl_turma_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_tbl_turma/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_tbl_turma</FONT></B> 
<br> 
...
<input type="submit" value="form_tbl_turma"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_tbl_turma_form_teste();
  $frm_teste->form_tbl_turma_teste();
?>
