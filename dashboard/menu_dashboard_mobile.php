...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["menu_dashboard"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>Sc8_Saphir/Sc8_Saphir_menuMobile.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>Sc8_Saphir/Sc8_Saphir_menuMobile<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" />
        <script src="<?php echo $_SESSION["scriptcase"]["menu_dashboard"]["glo_nm_path_prod"]; ?>/third/jquery/js/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menu_dashboard"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    </head>
    <body>
<style>
...
<table width="100%" height="67px" class="scMenuHHeader">
    ...
    <?php
        escreveMenuMobile($menu_dashboard_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
