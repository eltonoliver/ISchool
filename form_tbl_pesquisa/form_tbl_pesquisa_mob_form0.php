...
<?php
include_once("form_tbl_pesquisa_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbl_pesquisa_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['recarga'];
}
?>
...
<?php
 include_once("form_tbl_pesquisa_mob_js0.php");
?>
...
<form name="F1" method="post" 
               action="form_tbl_pesquisa_mob.php" 
               target="_self"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbl_pesquisa_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbl_pesquisa_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['run_iframe'] != "R")
{
?>
...
<?php
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['fast_search'][2] : "";
?> 
...
?>
<?php $sStyleHidden_escola_dumb = ('' == $sStyleHidden_escola) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_escola_dumb" style="<?php echo $sStyleHidden_escola_dumb; ?>"></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_cel" style="<?php echo $sStyleHidden_cel; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_cel"><?php echo $this->nm_new_label['cel']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['php_cmp_required']['cel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['php_cmp_required']['cel'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_cursos" style="<?php echo $sStyleHidden_cursos; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_cursos"><?php echo $this->nm_new_label['cursos']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['php_cmp_required']['cursos']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['php_cmp_required']['cursos'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'Atendente de Farmácia e Drogaria'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'Departamento de Pessoal'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'Controle Diário e Fluxo de Caixa'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'Recursos Humanos – Gerenciando Pessoas'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'Programa 5S – Qualidade Total nas Empresas'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'Sistema de Gestão Ambiental'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'Secretariado e Assessoria Administrativa'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'Técnicas de Administração – Gestão da Empresa Moderna'; ?>
 <option value="Microsoft Excel" <?php  if ($this->cursos == "Microsoft Excel") { echo " selected" ;} ?>>Microsoft Excel</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'Microsoft Excel'; ?>
 <option value="Microsoft Word" <?php  if ($this->cursos == "Microsoft Word") { echo " selected" ;} ?>>Microsoft Word</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'Microsoft Word'; ?>
 <option value="Microsoft PowerPoint" <?php  if ($this->cursos == "Microsoft PowerPoint") { echo " selected" ;} ?>>Microsoft PowerPoint</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'Microsoft PowerPoint'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'Conhecendo o Windows 8'; ?>
 <option value="Gestão de Pessoas" <?php  if ($this->cursos == "Gestão de Pessoas") { echo " selected" ;} ?>>Gestão de Pessoas</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'Gestão de Pessoas'; ?>
 <option value="English" <?php  if ($this->cursos == "English") { echo " selected" ;} ?>>English</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'English'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'Gestão de Crédito e Cobrança'; ?>
 <option value="Gestão de Vendas" <?php  if ($this->cursos == "Gestão de Vendas") { echo " selected" ;} ?>>Gestão de Vendas</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'Gestão de Vendas'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'Empreendedorismo – Passo a Passo'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'Operador de Caixa – Qualificando a Linha de Frente'; ?>
 <option value="Técnicas de Vendas" <?php  if ($this->cursos == "Técnicas de Vendas") { echo " selected" ;} ?>>Técnicas de Vendas</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'Técnicas de Vendas'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'Estoque e Compras – Introdução ás Práticas de Gestão Estratégica de Compras & Suprimentos'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'Marketing, Telemarketing & E-commerce'; ?>
 <option value="Programação com PHP" <?php  if ($this->cursos == "Programação com PHP") { echo " selected" ;} ?>>Programação com PHP</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'Programação com PHP'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'Programação com Linguagem Java'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['Lookup_cursos'][] = 'Desenvolvimento de Aplicativos para Android'; ?>
 </select></span>
</span><?php  }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['total'] + 1)?>);</script><?php } ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_pesquisa_mob']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
<?php
  }
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbl_pesquisa_mob");
 parent.scAjaxDetailHeight("form_tbl_pesquisa_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
