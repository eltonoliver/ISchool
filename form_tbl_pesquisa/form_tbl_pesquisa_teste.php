<?php  
  session_start() ;
  class form_tbl_pesquisa_form_teste
  {
   function form_tbl_pesquisa_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_tbl_pesquisa/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_tbl_pesquisa</FONT></B> 
<br> 
...
<input type="submit" value="form_tbl_pesquisa"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_tbl_pesquisa_form_teste();
  $frm_teste->form_tbl_pesquisa_teste();
?>
