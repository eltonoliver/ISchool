...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["ISchool_____grid_tbl_aluno"]))
   {
      unset($_SESSION['session_sec_aplicacao']["ISchool_____grid_tbl_aluno"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbl_aluno'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida_filho'] as $ind => $sc_init)
          {
