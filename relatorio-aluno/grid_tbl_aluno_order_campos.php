<?php
   ...
   session_start();
    $Ord_Cmp = new grid_tbl_aluno_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_tbl_aluno_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_converte["id"]   = "id";
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['labels']["id"] : "Código";
   $tab_ger_campos['matricula'] = "on";
   $tab_def_campos['matricula'] = "matricula";
   $tab_converte["matricula"]   = "matricula";
   $tab_labels["matricula"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['labels']["matricula"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['labels']["matricula"] : "Matrícula";
   $tab_ger_campos['nome'] = "on";
   $tab_def_campos['nome'] = "nome";
   $tab_converte["nome"]   = "nome";
   $tab_labels["nome"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['labels']["nome"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['labels']["nome"] : "Nome";
   $tab_ger_campos['sexo'] = "on";
   $tab_def_campos['sexo'] = "sexo";
   $tab_converte["sexo"]   = "sexo";
   $tab_labels["sexo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['labels']["sexo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['labels']["sexo"] : "Sexo";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['labels']["sc_field_0"] : "Responsável";
   $tab_ger_campos['matricula_img'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['matricula_img'] = "matricula_img";
       $tab_converte["matricula_img"]   = "matricula_img";
   }
   else
   {
       $tab_def_campos['matricula_img'] = "";
       $tab_converte[""]   = "matricula_img";
   }
   $tab_labels["matricula_img"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['labels']["matricula_img"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['labels']["matricula_img"] : "Matrícular Aluno";
   $tab_ger_campos['financeiro'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['financeiro'] = "financeiro";
       $tab_converte["financeiro"]   = "financeiro";
   }
   else
   {
       $tab_def_campos['financeiro'] = "";
       $tab_converte[""]   = "financeiro";
   }
   $tab_labels["financeiro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['labels']["financeiro"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['labels']["financeiro"] : "Financeiro";
   $tab_ger_campos['sc_field_0'] = "none";
   $tab_ger_campos['matricula_img'] = "none";
   $tab_ger_campos['financeiro'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_tbl_aluno_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
