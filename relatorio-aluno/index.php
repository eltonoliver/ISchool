<?php
   include_once('grid_tbl_aluno_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_perfil']          = "";
   $_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_path_prod']       = "/scriptcase/prod";
   $_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_path_conf']       = "/Applications/NetMake/v8/wwwroot/scriptcase/conf";
   $_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_path_imagens']    = "/scriptcase/file/img";
   $_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_path_imag_temp']  = "/scriptcase/tmp";
   $_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_path_doc']        = "/Applications/NetMake/v8/wwwroot/scriptcase/file/doc";
   $_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_conexao']         = "conn_mysql";
//
class grid_tbl_aluno_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
   ...
   var $Gd_missing;
   var $sc_site_ssl;
   var $link_form_tbl_aluno;
   var $link_form_tbl_responsavel_edit;
   var $link_form_tbl_matricula_edit;
   var $link_accordeon_financeiro_blk;
   var $nm_cont_lin;
   var $nm_limite_lin;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno']['decimal_db'] = "."; 

      $this->nm_cod_apl      = "grid_tbl_aluno"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      //check prod
      if(empty($_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
      //check img
      if(empty($_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_path_imagens']))
      {
              /*check img*/$_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
      }
      //check tmp
      if(empty($_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_path_imag_temp']))
      {
              /*check tmp*/$_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
      }
      //check doc
      if(empty($_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_path_doc']))
      {
              /*check doc*/$_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
      }
      //end check publication with the prod
      $this->sc_site_ssl     = (isset($_SERVER['HTTP_REFERER']) && strtolower(substr($_SERVER['HTTP_REFERER'], 0, 5)) == 'https') ? true : false;
      $this->sc_protocolo    = ($this->sc_site_ssl) ? 'https://' : 'http://';
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/relatorio-aluno';
      ...
      {
          include_once("grid_tbl_aluno_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_add_dyn_search")
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno']['dyn_search_add']['cmp'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno']['dyn_search_add']['seq'] = $_POST['seq'];
          $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
      if (isset($_GET['nmgp_opcao']) && $_GET['nmgp_opcao'] == "ajax_aut_comp_dyn_search")
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno']['dyn_search_aut_comp']['cmp'] = $_GET['field'];
          $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno']['opcao'] = $_GET['origem'];
...
<?php
      ...
      $this->link_form_tbl_aluno =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('form_tbl_aluno') . "/" ; 
      $this->link_form_tbl_responsavel_edit =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('form_tbl_responsavel') . "/" ; 
      $this->link_form_tbl_matricula_edit =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('form_tbl_matricula') . "/" ; 
      $this->link_accordeon_financeiro_blk =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('accordeon_financeiro') . "/" ; 
      if ($Tp_init == "Path_sub")
      {
          return;
      }
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_conexao']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "grid_tbl_aluno_erro.class.php"); 
      $this->Erro = new grid_tbl_aluno_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('grid_tbl_aluno'); 
// 
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_conexao']) && $_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_perfil']) && $_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grid_tbl_aluno']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['grid_tbl_aluno']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno']['embutida_init']) 
      {
      }
// 
      if (isset($_SESSION['scriptcase']['glo_decimal_db']) && !empty($_SESSION['scriptcase']['glo_decimal_db']))
      {
         $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_tbl_aluno']['glo_nm_conexao'], $this->root . $this->path_prod, 'ISchool'); 
      } 
      else 
      { 
...
//
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'grid_tbl_aluno', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'grid_tbl_aluno', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'grid_tbl_aluno', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//===============================================================================
//
class grid_tbl_aluno_sub_css
{
   function grid_tbl_aluno_sub_css()
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['grid_tbl_aluno']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['grid_tbl_aluno'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class grid_tbl_aluno_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida'])
      { 
          ...
          { 
              ...
              foreach ($todo as $param)
              {
                   ...
                   if (1 < sizeof($cadapar))
                   {
                       ...
                       nm_limpa_str_grid_tbl_aluno($cadapar[1]);
                       nm_protect_num_grid_tbl_aluno($cadapar[0], $cadapar[1]);
                       $$cadapar[0] = $cadapar[1];
                       if ($cadapar[0] == "idAlunoFin") 
                       {
                           $_SESSION["idAlunoFin"] = $cadapar[1];
                       }
                       if ($cadapar[0] == "PostIdAluno") 
                       {
                           $_SESSION["PostIdAluno"] = $cadapar[1];
                       }
                   }
              }
          } 
          ...
          if (isset($idAlunoFin)) 
          {
              ...
              nm_limpa_str_grid_tbl_aluno($_SESSION["idAlunoFin"]);
          }
          if (!isset($PostIdAluno) && isset($postidaluno)) 
          {
             $PostIdAluno = $postidaluno;
          }
          if (isset($PostIdAluno)) 
          {
              $_SESSION['PostIdAluno'] = $PostIdAluno;
              nm_limpa_str_grid_tbl_aluno($_SESSION["PostIdAluno"]);
          }
      } 
      $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      if (!$this->Ini) 
      { 
          $this->Ini = new grid_tbl_aluno_ini(); 
          $this->Ini->init();
      } 
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("pt_br");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "relatorio-aluno/grid_tbl_aluno_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "grid_tbl_aluno_erro.class.php"); 
      } 
      $this->Erro      = new grid_tbl_aluno_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "relatorio-aluno/grid_tbl_aluno_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "grid_tbl_aluno_lookup.class.php"); 
      } 
      $this->Lookup       = new grid_tbl_aluno_lookup();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['ajax_nav'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['scroll_navigate'] = false;
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_navigate")
          {
              ob_start();
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['ajax_nav'] = true;
              $_SESSION['scriptcase']['saida_var']  = true;
              $_SESSION['scriptcase']['saida_html'] = "";
              $this->Ini->Arr_result = array();
              $nmgp_opcao = $_POST['opc'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] = $nmgp_opcao;
              if (isset($_POST['parm']) && $_POST['parm'] == "save_grid")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['save_grid'] = true;
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['Gera_log_access'])
      {
          $this->Ini->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['Gera_log_access'] = false;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['pdf_det'] = false;
      if ($nmgp_opcao == 'pdf_det')
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['pdf_det'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] = 'pdf';
          $nmgp_opcao = 'pdf';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida_treeview'] = false;
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['field_order']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['field_order'][] = "id";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['field_order'][] = "matricula";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['field_order'][] = "nome";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['field_order'][] = "sexo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['field_order'][] = "sc_field_0";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['field_order'][] = "matricula_img";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['field_order'][] = "financeiro";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['field_order'][] = "estadocivil";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['field_order'][] = "datanascimento";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['field_order_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['field_order'];
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['usr_cmp_sel']))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['usr_cmp_sel'] = array();
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['usr_cmp_sel']['estadocivil'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['usr_cmp_sel']['datanascimento'] = "off";
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbl_aluno']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbl_aluno']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['grid_tbl_aluno']['exit'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_orig']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] = "inicio" ;  
      }   
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbl_aluno']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbl_aluno']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] = "busca";
          }   
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida_form'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] == "busca")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] = "inicio";
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"]))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opc_liga'] = $NMSC_conf_apl;  
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['print_all'] = true;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['det_print'] = "";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] == "det_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao']     = "detalhe";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['det_print'] = "print";
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] == "fast_search")  
      { 
          $this->SC_fast_search($GLOBALS["nmgp_fast_search"], $GLOBALS["nmgp_cond_fast_search"], $GLOBALS["nmgp_arg_fast_search"]);
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_pesq_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_pesq'])
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] = 'igual';
          } 
          else 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_pesq'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['contr_array_resumo'] = "NAO";
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] = 'pesq';
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['orig_pesq'] = 'grid';
          } 
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] == "dyn_search" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] == "dyn_search_clear")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] == "dyn_search_clear")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['dyn_search_clear'] = true;
          } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] = 'inicio';
          } 
      } 
//
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"]))  
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['prim_cons'] = true;  
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_pesq_fast'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['contr_total_geral'] = "NAO";
   ...
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_pesq_filtro'];
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida'])
      {
         ...
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grid_tbl_aluno_html_" . session_id() . "_2.html";
            ...
            {
                $nm_arquivo_pdf_base = "/sc_pdf_" . date("YmdHis") . "_" . rand(0, 1000) . "_grid_tbl_aluno.pdf";
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            }
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grid_tbl_aluno_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->java_protocol . $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_grid_tbl_aluno_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] == "doc_word_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['print_navigator'] = "Microsoft Internet Explorer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['print_all'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['doc_word']  = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao']     = "resumo";
          $_SESSION['scriptcase']['saida_word'] = true;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['word_name']))
          {
              $nm_arquivo_doc_word = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['word_name'];
          }
          else
          {
              $nm_arquivo_doc_word = "/sc_grid_tbl_aluno_res_" . session_id() . ".doc";
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] == "xls")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "relatorio-aluno/grid_tbl_aluno_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_tbl_aluno_xls.class.php"); 
          } 
          $this->xls  = new grid_tbl_aluno_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] == "xml")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "relatorio-aluno/grid_tbl_aluno_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_tbl_aluno_xml.class.php"); 
          } 
          $this->xml  = new grid_tbl_aluno_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] == "csv")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "relatorio-aluno/grid_tbl_aluno_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_tbl_aluno_csv.class.php"); 
          } 
          $this->csv  = new grid_tbl_aluno_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] == "rtf")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "relatorio-aluno/grid_tbl_aluno_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_tbl_aluno_rtf.class.php"); 
          } 
          $this->rtf  = new grid_tbl_aluno_rtf();
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida'])
          { 
              require_once($this->Ini->path_embutida . " . relatorio-aluno . /" . $this->Ini->Apl_grafico); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
          } 
          $this->Graf  = new grid_tbl_aluno_grafico();
          $this->prep_modulos("Graf");
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'], 8));
          }
          else
          { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "grid_tbl_aluno_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_tbl_aluno_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new grid_tbl_aluno_pesq();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] == "resumo")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "relatorio-aluno/" . $this->Ini->Apl_resumo); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
          } 
          $this->Res = new grid_tbl_aluno_resumo("out");
          $this->prep_modulos("Res");
          $this->Res->monta_resumo();
      }
      else 
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] == "print" && $nmgp_tipo_print == "RC")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['print_navigator'] = $nmgp_navegator_print;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao']     = "pdf";
              $GLOBALS['nmgp_tipo_pdf'] = strtolower($nmgp_cor_print);
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] == "doc_word")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['print_navigator'] = "Microsoft Internet Explorer";
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['doc_word']  = true;
              ...
              {
                  $nm_arquivo_doc_word = "/sc_grid_tbl_aluno_" . session_id() . ".doc";
              }
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word);
          ...
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['chave_det'] = $nmgp_chave_det;
          } 
          if (isset($nmgp_parm_acum))  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['cmp_acum'] = $nmgp_parm_acum;
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['opcao'] == "detalhe" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['pdf_det'])  
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida'])
              { 
                  require_once($this->Ini->path_embutida . "relatorio-aluno/grid_tbl_aluno_det.class.php"); 
              } 
              else 
              { 
                  require_once($this->Ini->path_aplicacao . "grid_tbl_aluno_det.class.php"); 
              } 
              $this->det  = new grid_tbl_aluno_det();
          ...
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida'])
              { 
                  require_once($this->Ini->path_embutida . "relatorio-aluno/grid_tbl_aluno_grid.class.php"); 
              } 
              else 
              { 
                  require_once($this->Ini->path_aplicacao . "grid_tbl_aluno_grid.class.php"); 
              } 
              $this->grid  = new grid_tbl_aluno_grid();
...
//--- 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['embutida'])
      {
         ...
         {
             $this->Ini->Arr_result['setVar'][] = array('var' => 'scQtReg', 'value' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['qt_reg_grid']);
             $Temp = ob_get_clean();
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['word_file'] = $this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['pdf_det'])
            {
            ...
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['pdf_name']))
            {
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['pdf_name']);
            }
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['pdf_file'] = $nm_arquivo_pdf_serv;
}
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['pdf_det'])
{
...
<?php
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          $tmp_cmd = "";
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_orig'])) 
          {
              $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_orig']; 
          }
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_pesq_filtro'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_pesq_filtro'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_pesq_filtro'] . ")"; 
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_pesq'] = $tmp_cmd;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['fast_search']);
          return;
      }
      $comando = "";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_pesq_fast'] = $comando;
      $tmp_cmd = "";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_orig'])) 
      {
          $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_orig']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_pesq'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['fast_search'][2] = $sv_data;
   }
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['decimal_db'] == ".")
         {
             $nm_aspas = "";
         }
         if (is_array($campo))
   ...
   function SC_lookup_cidades_id_nasc($condicao, $campo)
   {
       $result = array();
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       $nm_comando = "SELECT nome, id FROM cidades WHERE (nome LIKE '%$campo%')" ; 
       if ($condicao == "ii")
       {
           $nm_comando = str_replace("LIKE '%$campo%'", "LIKE '$campo%'", $nm_comando);
       }
   ...
   function SC_proc_dyn_search($Parms)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['dyn_search'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['dyn_refresh'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['tmp_busca'] = array();
       foreach ($tmp as $cada_f)
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['dyn_search'][] = array('cmp' => $dats[0], 'opc' => $dats[1], 'val' => $val_sv);
           $ix++;
       }
      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['tmp_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['tmp_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['tmp_busca'] as $ind => $dados)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['campos_busca'][$ind] = $dados;
      }
       $this->Dyn_Serarch_and_or = "and";
       $this->Cmd_Dyn_Search    = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['cond_dyn_search'] = "";
       foreach ($fields as $ind => $dados)
       {
           ...
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['dyn_search_label']['id'];
           ...
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['dyn_search_label']['matricula'];
               $dados['vls'][0] = $dados['vls'][0][0];
               $this->Val_format_1 = $dados['vls'][0];
           ...
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['dyn_search_label']['nome'];
               $dados['vls'][0] = $dados['vls'][0][0];
               $this->Val_format_1 = $dados['vls'][0];
           ...
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['dyn_search_label']['cpf'];
               $dados['vls'][0] = $dados['vls'][0][0];
               $this->Val_format_1 = $dados['vls'][0];
               $this->SC_proc_dyn_search_all($dados['cond'], $dados['vls'], "cpf", 'A', 'VARCHAR', $Label_cmp);
           }
           if ($dados['field'] == "rg" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['dyn_search_label']['rg'];
               $dados['vls'][0] = $dados['vls'][0][0];
               $this->Val_format_1 = $dados['vls'][0];
               $this->SC_proc_dyn_search_all($dados['cond'], $dados['vls'], "rg", 'A', 'VARCHAR', $Label_cmp);
           }
           if ($dados['field'] == "datanascimento" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['dyn_search_label']['datanascimento'];
               if ($dados['cond'] != "TP")
               {
                   ...
                   $this->nm_prep_date($val, "DH", "DATETIME", $dados['cond'] , "");
                   ...
                   $this->SC_proc_dyn_search_all($dados['cond'], $val, "dataNascimento", 'DH', 'DATETIME', $Label_cmp);
               }
           }
       }
       if (empty($this->Cmd_Dyn_Search)) 
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['cond_pesq']         = "";
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['cond_dyn_search']   = "";
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['campos_busca']      = array();
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_pesq_fast'])) 
           {
               if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_pesq'])) 
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_pesq_fast'] . ")";
               }
               else 
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_pesq_fast'] . ")";
               }
           }
           return;
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_pesq_filtro'] = "( " . $this->Cmd_Dyn_Search . " )";
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_orig'])) 
       {
           $this->Cmd_Dyn_Search = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_orig'] . " and (" . $this->Cmd_Dyn_Search . ")"; 
       }
       else
       {
           $this->Cmd_Dyn_Search = " where " . $this->Cmd_Dyn_Search; 
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_pesq'] = $this->Cmd_Dyn_Search;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['cond_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['cond_dyn_search'] . $this->Dyn_Serarch_and_or;
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_pesq_fast'])) 
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['where_pesq_fast'] . ")";
       }
       if (NM_is_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['cond_pesq']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['cond_pesq'] = mb_convert_encoding($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['cond_pesq'], $_SESSION['scriptcase']['charset'], "UTF-8");
       }
   }
   function SC_proc_dyn_search_lookup($cond, $vls, $sql, $tp, $tsql, $lab)
   {
       ...
       if (!empty($nm_cmd))
       {
           ...
           if ($cond == "DF")
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['cond_dyn_search'] .= $lab . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $nm_cond . "##*@@";
           }
           else
           {
               $this->Cmd_Dyn_Search .= "(" . $sql . " in (" . $nm_cmd . "))";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['cond_dyn_search'] .= $lab . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
           }
       }
   }
   ...
   {
       $nm_aspas = "'";
       if ($tp == "N" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['decimal_db'] == ".")
       {
           $nm_aspas = "";
       }
      if (($tp == "DT" || $tp == "DH" || $tp == "HH") && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      {
       ...
       $dados   = $vls[0];
           ...
           if (!empty($nm_cmd))
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['cond_dyn_search'] .= $nm_cond;
           }
   }
...
<input type="hidden" name="nm_tit_doc" value="grid_tbl_aluno.doc"> 
...
<form name="Fdown" method="get" action="grid_tbl_aluno_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="nm_tit_doc" value="grid_tbl_aluno_det.pdf"> 
...
//======= =========================
   ...
   {
       include_once("grid_tbl_aluno_nmutf8.php");
   }
   ...
   $_SESSION['scriptcase']['grid_tbl_aluno']['contr_erro'] = 'off';
   $sc_conv_var = array();
   $sc_conv_var['responsável'] = "sc_field_0";
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_grid_tbl_aluno($nmgp_val);
            nm_protect_num_grid_tbl_aluno($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['grid_tbl_aluno']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['grid_tbl_aluno']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['grid_tbl_aluno']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['grid_tbl_aluno']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['grid_tbl_aluno']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['grid_tbl_aluno']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['grid_tbl_aluno']['embutida_form_parms']);
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']);
               $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['b_sair'] = false;
           }   
       } 
   } 
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['grid_tbl_aluno']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['grid_tbl_aluno']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['grid_tbl_aluno']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['grid_tbl_aluno']['protect_modal']) && !empty($_SESSION['scriptcase']['grid_tbl_aluno']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['grid_tbl_aluno']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        {
            $_SESSION['scriptcase']['sc_apl_menu_atual'] = "grid_tbl_aluno";
        }
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            ...
            {
                if ($nome_apl == 'grid_tbl_aluno' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['initialize'] = false;
   }
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/relatorio-aluno/'))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['initialize'] = true;
   }
   else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['contr_total_geral'] = "NAO";
   }

   $_POST['script_case_init'] = $script_case_init;
   if (isset($nmgp_opcao) && $nmgp_opcao == "busca" && isset($nmgp_orig_pesq))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['orig_pesq'] = $nmgp_orig_pesq;
   }
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['b_sair'] = true;
   }
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'grid_tbl_aluno')
   {
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/grid_tbl_aluno_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['opcao'] = $nmgp_opcao ;  
       }   
       if ($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['opcao'] == "detalhe" && isset($nmgp_chave_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['chave_det'] = $nmgp_chave_det;
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['cmp_acum']  = $nmgp_parm_acum;
       }   
       ...
       if (!isset($_SESSION["PostIdAluno"])) 
       {
           $_SESSION["PostIdAluno"] = "";
       }
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['mostra_edit'] = "S";
       }
       if (isset($nmgp_lig_edit_lapis)) 
       {
          $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['volta_redirect_tp'] = "";
           $nm_url_saida = "grid_tbl_aluno_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['sc_modal'] = true;
               }
               $nm_url_saida = "grid_tbl_aluno_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['opcao'] != "pdf" ) 
       { 
            $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['menu_desenv'] = true;   
       } 
       if (isset($_GET["nmgp_parms_ret"])) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['opc_psq'] = true ;   
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['opc_psq'] = false ;   
       } 
       if ($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida_form'])
       {
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['mostra_edit'] = "N";   
       ...
       $contr_grid_tbl_aluno = new grid_tbl_aluno_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['opcao'] = "busca";
          $contr_grid_tbl_aluno->NM_ajax_flag = true;
          $contr_grid_tbl_aluno->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['opcao'] = "busca";
          $contr_grid_tbl_aluno->NM_ajax_flag = true;
          $contr_grid_tbl_aluno->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['opcao'] = "busca";
          $contr_grid_tbl_aluno->NM_ajax_flag = true;
          $contr_grid_tbl_aluno->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['opcao'] = "busca";
          $contr_grid_tbl_aluno->NM_ajax_flag = true;
          $contr_grid_tbl_aluno->NM_ajax_opcao = "ajax_filter_select";
      }
       $contr_grid_tbl_aluno->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_grid_tbl_aluno(&$str)
   {
   ...
   function nm_protect_num_grid_tbl_aluno($name, &$val)
   {
       if (empty($val))
       {
          return;
   ...
   function grid_tbl_aluno_pack_protect_string($sString)
   {
