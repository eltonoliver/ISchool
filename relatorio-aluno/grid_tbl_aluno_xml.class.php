...
class grid_tbl_aluno_xml
{
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo     .= ".xml";
      $this->tit_doc      = "grid_tbl_aluno.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['xml_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['xml_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_tbl_aluno";
         $this->id = $rs->fields[0] ;  
   ...
   function NM_export_matricula()
   {
         ...
         {
             $this->matricula = mb_convert_encoding($this->matricula, "UTF-8");
         }
   ...
   function NM_export_nome()
   {
         ...
         {
             $this->nome = mb_convert_encoding($this->nome, "UTF-8");
         }
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_sexo))
         {
             $this->look_sexo = mb_convert_encoding($this->look_sexo, "UTF-8");
         }
         $this->xml_registro .= " sexo =\"" . $this->trata_dados($this->look_sexo) . "\"";
   }
   //----- sc_field_0
   function NM_export_sc_field_0()
   {
         ...
         $this->xml_registro .= " Responsável =\"" . $this->trata_dados($this->sc_field_0) . "\"";
   }
   //----- matricula_img
   function NM_export_matricula_img()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->matricula_img))
         {
             $this->matricula_img = mb_convert_encoding($this->matricula_img, "UTF-8");
         }
         $this->xml_registro .= " matricula_img =\"" . $this->trata_dados($this->matricula_img) . "\"";
   }
   //----- financeiro
   function NM_export_financeiro()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->financeiro))
         {
             $this->financeiro = mb_convert_encoding($this->financeiro, "UTF-8");
         }
         $this->xml_registro .= " financeiro =\"" . $this->trata_dados($this->financeiro) . "\"";
   }
   //----- estadocivil
   function NM_export_estadocivil()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_estadocivil))
         {
             $this->look_estadocivil = mb_convert_encoding($this->look_estadocivil, "UTF-8");
         }
         $this->xml_registro .= " estadocivil =\"" . $this->trata_dados($this->look_estadocivil) . "\"";
   }
   //----- datanascimento
   function NM_export_datanascimento()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->datanascimento))
         {
             $this->datanascimento = mb_convert_encoding($this->datanascimento, "UTF-8");
         }
         $this->xml_registro .= " datanascimento =\"" . $this->trata_dados($this->datanascimento) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
