<?php  
  session_start() ;
  class ischool_form_sec_groups_apps_form_teste
  {
   function ischool_form_sec_groups_apps_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "ischool_form_sec_groups_apps/img";
...
?> 
<br> 
<B><FONT SIZE="4">ischool_form_sec_groups_apps</FONT></B> 
<br> 
<form name="Fedit" method="post" 
               action="index.php" 
               target="_self"> 
<input type="hidden" name="script_case_session" value="<?php echo session_id() ?>"/><input type="hidden" name="nmgp_outra_jan" value="true"/>group&nbsp;&nbsp;<input type="text" name="group" size=20><br> 
<input type="hidden" name="NM_contr_var_session" value="Yes"> 
<input type="submit" value="ischool_form_sec_groups_apps"> 
</form> 
...
<?php
  ...
  $frm_teste = new ischool_form_sec_groups_apps_form_teste();
  $frm_teste->ischool_form_sec_groups_apps_teste();
?>
