...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('blur', function() { sc_calendar_tbl_tmk_id_onblur(this, iSeqRow) })
                                .bind('focus', function() { sc_calendar_tbl_tmk_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_title' + iSeqRow).bind('blur', function() { sc_calendar_tbl_tmk_title_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_calendar_tbl_tmk_title_onfocus(this, iSeqRow) });
  $('#id_sc_field_description' + iSeqRow).bind('blur', function() { sc_calendar_tbl_tmk_description_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_calendar_tbl_tmk_description_onfocus(this, iSeqRow) });
  $('#id_sc_field_start_date' + iSeqRow).bind('blur', function() { sc_calendar_tbl_tmk_start_date_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_calendar_tbl_tmk_start_date_onfocus(this, iSeqRow) });
  $('#id_sc_field_end_date' + iSeqRow).bind('blur', function() { sc_calendar_tbl_tmk_end_date_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_calendar_tbl_tmk_end_date_onfocus(this, iSeqRow) });
  $('#id_sc_field_recurrent' + iSeqRow).bind('blur', function() { sc_calendar_tbl_tmk_recurrent_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_calendar_tbl_tmk_recurrent_onfocus(this, iSeqRow) });
  $('#id_sc_field_period' + iSeqRow).bind('blur', function() { sc_calendar_tbl_tmk_period_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_calendar_tbl_tmk_period_onfocus(this, iSeqRow) });
  $('#id_sc_field_horarioinicial' + iSeqRow).bind('blur', function() { sc_calendar_tbl_tmk_horarioinicial_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_calendar_tbl_tmk_horarioinicial_onfocus(this, iSeqRow) });
  $('#id_sc_field_horariofinal' + iSeqRow).bind('blur', function() { sc_calendar_tbl_tmk_horariofinal_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_calendar_tbl_tmk_horariofinal_onfocus(this, iSeqRow) });
  $('#id_sc_field___calend_all_day__' + iSeqRow).bind('blur', function() { sc_calendar_tbl_tmk___calend_all_day___onblur(this, iSeqRow) })
                                                .bind('click', function() { sc_calendar_tbl_tmk___calend_all_day___onclick(this, iSeqRow) })
                                                .bind('focus', function() { sc_calendar_tbl_tmk___calend_all_day___onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_calendar_tbl_tmk_id_onblur(oThis, iSeqRow) {
  do_ajax_calendar_tbl_tmk_mob_validate_id();
  scCssBlur(oThis);
}

function sc_calendar_tbl_tmk_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendar_tbl_tmk_title_onblur(oThis, iSeqRow) {
  do_ajax_calendar_tbl_tmk_mob_validate_title();
  scCssBlur(oThis);
}

function sc_calendar_tbl_tmk_title_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendar_tbl_tmk_description_onblur(oThis, iSeqRow) {
  do_ajax_calendar_tbl_tmk_mob_validate_description();
  scCssBlur(oThis);
}

function sc_calendar_tbl_tmk_description_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendar_tbl_tmk_start_date_onblur(oThis, iSeqRow) {
  do_ajax_calendar_tbl_tmk_mob_validate_start_date();
  scCssBlur(oThis);
}

function sc_calendar_tbl_tmk_start_date_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendar_tbl_tmk_end_date_onblur(oThis, iSeqRow) {
  do_ajax_calendar_tbl_tmk_mob_validate_end_date();
  scCssBlur(oThis);
}

function sc_calendar_tbl_tmk_end_date_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendar_tbl_tmk_recurrent_onblur(oThis, iSeqRow) {
  do_ajax_calendar_tbl_tmk_mob_validate_recurrent();
  scCssBlur(oThis);
}

function sc_calendar_tbl_tmk_recurrent_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendar_tbl_tmk_period_onblur(oThis, iSeqRow) {
  do_ajax_calendar_tbl_tmk_mob_validate_period();
  scCssBlur(oThis);
}

function sc_calendar_tbl_tmk_period_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendar_tbl_tmk_horarioinicial_onblur(oThis, iSeqRow) {
  do_ajax_calendar_tbl_tmk_mob_validate_horarioinicial();
  scCssBlur(oThis);
}

function sc_calendar_tbl_tmk_horarioinicial_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendar_tbl_tmk_horariofinal_onblur(oThis, iSeqRow) {
  do_ajax_calendar_tbl_tmk_mob_validate_horariofinal();
  scCssBlur(oThis);
}

function sc_calendar_tbl_tmk_horariofinal_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendar_tbl_tmk___calend_all_day___onblur(oThis, iSeqRow) {
  do_ajax_calendar_tbl_tmk_mob_validate___calend_all_day__();
  scCssBlur(oThis);
}

function sc_calendar_tbl_tmk___calend_all_day___onclick(oThis, iSeqRow) {
  sc___calend_all_day___onclick();
}

function sc_calendar_tbl_tmk___calend_all_day___onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
