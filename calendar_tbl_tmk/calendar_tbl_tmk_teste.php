<?php  
  session_start() ;
  class calendar_tbl_tmk_form_teste
  {
   function calendar_tbl_tmk_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "calendar_tbl_tmk/img";
...
?> 
<br> 
<B><FONT SIZE="4">calendar_tbl_tmk</FONT></B> 
<br> 
<form name="Fedit" method="post" 
               action="index.php" 
               target="_self"> 
<input type="hidden" name="script_case_session" value="<?php echo session_id() ?>"/><input type="hidden" name="nmgp_outra_jan" value="true"/>user_id&nbsp;&nbsp;<input type="text" name="user_id" size=20><br> 
<input type="hidden" name="NM_contr_var_session" value="Yes"> 
<input type="submit" value="calendar_tbl_tmk"> 
</form> 
<script language=javascript> 
 document.Fedit.user_id.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new calendar_tbl_tmk_form_teste();
  $frm_teste->calendar_tbl_tmk_teste();
?>
