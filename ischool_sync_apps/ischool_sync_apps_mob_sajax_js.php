  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_ischool_sync_apps_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate sync
  function do_ajax_ischool_sync_apps_mob_validate_sync()
  {
  } // do_ajax_ischool_sync_apps_mob_validate_sync

  function do_ajax_ischool_sync_apps_mob_validate_sync_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ischool_sync_apps_mob_validate_sync_cb
  // ---------- Form
  function do_ajax_ischool_sync_apps_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_ischool_sync_apps_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_ischool_sync_apps_mob_submit_form(var_sync, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_ischool_sync_apps_mob_submit_form_cb);
  } // do_ajax_ischool_sync_apps_mob_submit_form

  function do_ajax_ischool_sync_apps_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_ischool_sync_apps_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_ischool_sync_apps_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_ischool_sync_apps_mob_navigate_form

  function do_ajax_ischool_sync_apps_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_ischool_sync_apps_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_ischool_sync_apps_mob_navigate_form_cb
