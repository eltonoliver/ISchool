<?php  
  session_start() ;
  class ischool_sync_apps_form_teste
  {
   function ischool_sync_apps_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "ischool_sync_apps/img";
...
?> 
<br> 
<B><FONT SIZE="4">ischool_sync_apps</FONT></B> 
<br> 
...
<input type="submit" value="ischool_sync_apps"> 
</form> 
...
<?php
  ...
  $frm_teste = new ischool_sync_apps_form_teste();
  $frm_teste->ischool_sync_apps_teste();
?>
