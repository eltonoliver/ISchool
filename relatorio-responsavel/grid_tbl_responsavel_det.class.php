<?php
//--- 
class grid_tbl_responsavel_det
{
   var $Ini;
   var $Erro;
   var $Db;
 ...
 function monta_det()
 {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_responsavel']['seq_dir'] = 0; 
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_responsavel']['sub_dir'] = array(); 
   ...
   $parms_det = explode(";", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_responsavel']['chave_det']) ; 
   ...
   {
       $nmgp_select .= " where  id = $parms_det[0] and nome = '$parms_det[1]' and cpf = '$parms_det[2]' and rg = '$parms_det[3]' and dataExpedicao = #$parms_det[4]# and login = '$parms_det[5]'" ;  
   } 
   else 
   { 
       $nmgp_select .= " where  id = $parms_det[0] and nome = '$parms_det[1]' and cpf = '$parms_det[2]' and rg = '$parms_det[3]' and dataExpedicao = '$parms_det[4]' and login = '$parms_det[5]'" ;  
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_responsavel']['cmp_acum']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_responsavel']['cmp_acum']))
   {
       $parms_acum = explode(";", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_responsavel']['cmp_acum']);
...
//--- 
   ...
   $nm_saida->saida("<HEAD>\r\n");
   $nm_saida->saida("   <TITLE>" . $this->Ini->Nm_lang['lang_othr_detl_titl'] . " - tbl_responsavel</TITLE>\r\n");
   ...
   if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_responsavel']['det_print'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
   {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_responsavel']['pdf_det'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_responsavel']['det_print'] != "print")
   {
   ...
   $nm_saida->saida("<table border=0 align=\"center\" valign=\"top\" ><tr><td style=\"padding: 0px\"><div class=\"scGridBorder\"><table><tr><td>\r\n");
   ...
   $nm_saida->saida("    	<tr>\r\n");
   $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"scGridHeaderFont\"><span>" . $this->Ini->Nm_lang['lang_othr_detl_titl'] . " - tbl_responsavel</span></td>\r\n");
   ...
   $nm_saida->saida("  </TD>\r\n");
   $nm_saida->saida(" </TR>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_responsavel']['det_print'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_responsavel']['pdf_det']) 
   { 
       $nm_saida->saida("   <tr><td class=\"scGridTabelaTd\">\r\n");
       ...
       {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Dpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "relatorio-responsavel/grid_tbl_responsavel_config_pdf.php?nm_opc=pdf_det&nm_target=0&nm_cor=cor&papel=1&orientacao=1&largura=1200&conf_larg=S&conf_fonte=10&language=pt_br&conf_socor=S&KeepThis=false&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
       }
       if ($this->nmgp_botoes['det_print'] == "on")
       {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Dprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "relatorio-responsavel/grid_tbl_responsavel_config_print.php?nm_opc=detalhe&nm_cor=AM&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
       }
   ...
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['numerocel'])) ? $this->New_label['numerocel'] : "Numero Cel"; 
   ...
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['numerotel'])) ? $this->New_label['numerotel'] : "Numero Tel"; 
   ...
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['sc_field_0'])) ? $this->New_label['sc_field_0'] : "E Mail"; 
   ...
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['estados_id'])) ? $this->New_label['estados_id'] : "Estados Id"; 
          $conteudo = trim($this->estados_id); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   ...
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['cidades_id'])) ? $this->New_label['cidades_id'] : "Cidades Id"; 
          $conteudo = trim($this->cidades_id); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   ...
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['aluno_id'])) ? $this->New_label['aluno_id'] : "Aluno Id"; 
          $conteudo = trim($this->aluno_id); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
...
//--- 
   ...
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("       NovaJanela = window.open (\"grid_tbl_responsavel_doc.php?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&nm_cod_doc=\" + campo1 + \"&nm_nome_doc=\" + campo2 + \"&nm_cod_apl=\" + campo3, \"ScriptCase\", \"resizable\");\r\n");
   $nm_saida->saida("   }\r\n");
   $nm_saida->saida("   function nm_gp_move(x, y, z, p, g) \r\n");
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "relatorio-responsavel/index.php?nmgp_opcao=pdf_det&nmgp_tipo_pdf=\" + z + \"&nmgp_parms_pdf=\" + p +  \"&nmgp_graf_pdf=\" + g + \"&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "\";\r\n");
   $nm_saida->saida("   }\r\n");
