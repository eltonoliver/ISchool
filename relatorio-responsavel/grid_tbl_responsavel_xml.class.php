...
class grid_tbl_responsavel_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_tbl_responsavel_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo     .= ".xml";
      $this->tit_doc      = "grid_tbl_responsavel.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_responsavel']['xml_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_responsavel']['xml_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_responsavel']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_responsavel']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_tbl_responsavel";
         $this->id = $rs->fields[0] ;  
   ...
   function NM_export_dataexpedicao()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->dataexpedicao))
         {
             $this->dataexpedicao = mb_convert_encoding($this->dataexpedicao, "UTF-8");
         }
         $this->xml_registro .= " dataexpedicao =\"" . $this->trata_dados($this->dataexpedicao) . "\"";
   }
   //----- login
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_responsavel']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_responsavel']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - tbl_responsavel :: XML</TITLE>
