<?php
   ...
   session_start();
    $Ord_Cmp = new grid_tbl_responsavel_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_tbl_responsavel_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_converte["id"]   = "id";
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_responsavel']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_responsavel']['labels']["id"] : "Id";
   $tab_ger_campos['nome'] = "on";
   $tab_def_campos['nome'] = "nome";
   $tab_converte["nome"]   = "nome";
   $tab_labels["nome"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_responsavel']['labels']["nome"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_responsavel']['labels']["nome"] : "Nome";
   $tab_ger_campos['cpf'] = "on";
   $tab_def_campos['cpf'] = "cpf";
   $tab_converte["cpf"]   = "cpf";
   $tab_labels["cpf"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_responsavel']['labels']["cpf"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_responsavel']['labels']["cpf"] : "Cpf";
   $tab_ger_campos['rg'] = "on";
   $tab_def_campos['rg'] = "rg";
   $tab_converte["rg"]   = "rg";
   $tab_labels["rg"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_responsavel']['labels']["rg"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_responsavel']['labels']["rg"] : "Rg";
   $tab_ger_campos['dataexpedicao'] = "on";
   $tab_def_campos['dataexpedicao'] = "dataExpedicao";
   $tab_converte["dataExpedicao"]   = "dataexpedicao";
   $tab_labels["dataexpedicao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_responsavel']['labels']["dataexpedicao"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_responsavel']['labels']["dataexpedicao"] : "Data Expedicao";
   $tab_ger_campos['login'] = "on";
   $tab_def_campos['login'] = "login";
   $tab_converte["login"]   = "login";
   $tab_labels["login"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_responsavel']['labels']["login"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_responsavel']['labels']["login"] : "Login";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_responsavel']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbl_responsavel']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbl_responsavel']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbl_responsavel']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbl_responsavel']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbl_responsavel']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbl_responsavel']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbl_responsavel']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbl_responsavel']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - tbl_responsavel</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_tbl_responsavel_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbl_responsavel']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_tbl_responsavel']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
