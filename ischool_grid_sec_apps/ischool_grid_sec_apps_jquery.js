...
function ajax_navigate(opc, parm)
{
    ...
    $.ajax({
      ...
      success: function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_ischool_grid_sec_apps').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_ischool_grid_sec_apps').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_ischool_grid_sec_apps').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_ischool_grid_sec_apps').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_ischool_grid_sec_apps').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_ischool_grid_sec_apps').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_ischool_grid_sec_apps').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_ischool_grid_sec_apps').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_ischool_grid_sec_apps').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_ischool_grid_sec_apps').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_ischool_grid_sec_apps').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_ischool_grid_sec_apps').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
