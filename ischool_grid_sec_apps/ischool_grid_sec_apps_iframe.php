...
$oExportPdf = new ischool_grid_sec_apps_export_pdf;
$oExportPdf->exportPdf();

class ischool_grid_sec_apps_export_pdf {
...
?>
 ...
 function checkPDF() {
  $.get(nm_url_rand("ischool_grid_sec_apps_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['ischool_grid_sec_apps']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['ischool_grid_sec_apps']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_ischool_grid_sec_apps.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['ischool_grid_sec_apps']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['ischool_grid_sec_apps']['pdf_name'] : "ischool_grid_sec_apps.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
?>
