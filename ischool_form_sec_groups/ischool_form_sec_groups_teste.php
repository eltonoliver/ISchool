<?php  
  session_start() ;
  class ischool_form_sec_groups_form_teste
  {
   function ischool_form_sec_groups_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "ischool_form_sec_groups/img";
...
?> 
<br> 
<B><FONT SIZE="4">ischool_form_sec_groups</FONT></B> 
<br> 
...
<input type="submit" value="ischool_form_sec_groups"> 
</form> 
...
<?php
  ...
  $frm_teste = new ischool_form_sec_groups_form_teste();
  $frm_teste->ischool_form_sec_groups_teste();
?>
