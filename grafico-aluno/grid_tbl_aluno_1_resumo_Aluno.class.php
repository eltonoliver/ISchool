...
class grid_tbl_aluno_1_resumo
{
   ...
   //---- 
   function grid_tbl_aluno_1_resumo($tipo = "")
   {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_resumo'] = "";
      $this->inicializa_vars();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['contr_total_geral'] == "OK")
      {
          $this->array_total_nome = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['arr_total']['nome'];
      }
      else
      {
          $this->array_total_nome = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['tot_geral'][1] == 0)
      {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['arr_total']['nome'] = $this->array_total_nome;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['contr_array_resumo'] = "OK";
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['summarizing_fields_order']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['summarizing_fields_order'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['summarizing_fields_order'];
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['summarizing_fields_display']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
           }
       }
       else
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['summarizing_fields_display'] as $i_sum => $d_sum)
           {
               $this->comp_sum_display[$i_sum] = $d_sum['display'];
           }
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['summarizing_fields_control']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['summarizing_fields_control'] = array(
               'NM_Count' => array(
       ...
       //-----
       foreach ($this->array_total_nome as $i_nome => $d_nome) {
           if (!in_array($i_nome, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_nome[2] ] = $d_nome[1];
               $this->comp_label[0][ $d_nome[2] ] = $d_nome[1];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_tabular'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_nome => $l_nome) {
           if (isset($this->array_total_nome[$i_nome])) {
               $this->comp_group[$i_nome] = array();
           }
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Nome"),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_charts'] = $this->comp_chart_data;
   }
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_grid_tbl_aluno_1_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_grid_tbl_aluno_1_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida'])
                   {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_tbl_aluno_1_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] = "print";
      ...
      $this->total   = new grid_tbl_aluno_1_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_Aluno("res", $this->array_total_nome);
      ksort($this->array_total_nome);
      if ("out" == $this->tipo)
      {
         $this->total->quebra_geral();
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['doc_word'])
{
      ...
      $sFusionChartModule = grid_tbl_aluno_1_grafico::getChartModule();
      if ('' == $sFusionChartModule)
      {
          $sFusionChartModule = grid_tbl_aluno_1_grafico::getChartModule('Pyramid');
      }
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_tbl_aluno_1_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_tbl_aluno_1_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_tbl_aluno_1_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['num_css'] . '.css');
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
...
{ 
       ...
       $nm_saida->saida("  tb_show('', 'grid_tbl_aluno_1_config_pivot.php?nome_apl=grid_tbl_aluno_1&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_tbl_aluno_1_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['num_css'] . '.css', 'a');
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new grid_tbl_aluno_1_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_nome, $quebra_nome_orig)
   {
      //----- Nome
      if (!isset($this->array_total_nome[$quebra_nome_orig]))
      {
         $this->array_total_nome[$quebra_nome_orig][0] = 1;
         $this->array_total_nome[$quebra_nome_orig][1] = $quebra_nome;
         $this->array_total_nome[$quebra_nome_orig][2] = $quebra_nome_orig;
      }
      else
      {
         $this->array_total_nome[$quebra_nome_orig][0]++;
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->matricula = $rs_res->fields[1] ;  
            $this->nome = $rs_res->fields[2] ;  
            $this->foto = $rs_res->fields[3] ;  
            $this->sexo = $rs_res->fields[4] ;  
            $this->cpf = $rs_res->fields[5] ;  
            $this->rg = $rs_res->fields[6] ;  
            $this->estadocivil = $rs_res->fields[7] ;  
            $this->nome_orig = $this->nome;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->nome, $this->nome_orig);
            }
   }
//
