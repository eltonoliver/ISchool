...
class grid_tbl_aluno_1_xml
{
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo     .= ".xml";
      $this->tit_doc      = "grid_tbl_aluno_1.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['xml_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['xml_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_tbl_aluno_1";
         $this->id = $rs->fields[0] ;  
   ...
   function NM_export_foto()
   {
         ...
         {
             $this->foto = mb_convert_encoding($this->foto, "UTF-8");
         }
   ...
   function NM_export_cpf()
   {
         ...
         {
             $this->cpf = mb_convert_encoding($this->cpf, "UTF-8");
         }
   ...
   function NM_export_rg()
   {
         ...
         {
             $this->rg = mb_convert_encoding($this->rg, "UTF-8");
         }
         $this->xml_registro .= " rg =\"" . $this->trata_dados($this->rg) . "\"";
   }
   //----- estadocivil
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE>Relatório de Alunos :: XML</TITLE>
