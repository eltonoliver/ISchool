<?php
   ...
   session_start();
    $Ord_Cmp = new grid_tbl_aluno_1_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_tbl_aluno_1_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_converte["id"]   = "id";
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['labels']["id"] : "Código";
   $tab_ger_campos['matricula'] = "on";
   $tab_def_campos['matricula'] = "matricula";
   $tab_converte["matricula"]   = "matricula";
   $tab_labels["matricula"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['labels']["matricula"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['labels']["matricula"] : "Matrícula";
   $tab_ger_campos['nome'] = "on";
   $tab_def_campos['nome'] = "nome";
   $tab_converte["nome"]   = "nome";
   $tab_labels["nome"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['labels']["nome"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['labels']["nome"] : "Nome";
   $tab_ger_campos['foto'] = "on";
   $tab_def_campos['foto'] = "foto";
   $tab_converte["foto"]   = "foto";
   $tab_labels["foto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['labels']["foto"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['labels']["foto"] : "Foto";
   $tab_ger_campos['sexo'] = "on";
   $tab_def_campos['sexo'] = "sexo";
   $tab_converte["sexo"]   = "sexo";
   $tab_labels["sexo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['labels']["sexo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['labels']["sexo"] : "Sexo";
   $tab_ger_campos['cpf'] = "on";
   $tab_def_campos['cpf'] = "cpf";
   $tab_converte["cpf"]   = "cpf";
   $tab_labels["cpf"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['labels']["cpf"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['labels']["cpf"] : "CPF";
   $tab_ger_campos['rg'] = "on";
   $tab_def_campos['rg'] = "rg";
   $tab_converte["rg"]   = "rg";
   $tab_labels["rg"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['labels']["rg"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['labels']["rg"] : "RG";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_tbl_aluno_1_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_tbl_aluno_1']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
