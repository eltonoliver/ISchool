<?php
   include_once('grid_tbl_aluno_1_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_perfil']          = "";
   $_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_path_prod']       = "/scriptcase/prod";
   $_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_path_conf']       = "/Applications/NetMake/v8/wwwroot/scriptcase/conf";
   $_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_path_imagens']    = "/scriptcase/file/img";
   $_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_path_imag_temp']  = "/scriptcase/tmp";
   $_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_path_doc']        = "/Applications/NetMake/v8/wwwroot/scriptcase/file/doc";
   $_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_conexao']         = "conn_mysql";
//
class grid_tbl_aluno_1_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno_1']['decimal_db'] = "."; 

      $this->nm_cod_apl      = "grid_tbl_aluno_1"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      //check prod
      if(empty($_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
      //check img
      if(empty($_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_path_imagens']))
      {
              /*check img*/$_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
      }
      //check tmp
      if(empty($_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_path_imag_temp']))
      {
              /*check tmp*/$_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
      }
      //check doc
      if(empty($_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_path_doc']))
      {
              /*check doc*/$_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
      }
      //end check publication with the prod
      $this->sc_site_ssl     = (isset($_SERVER['HTTP_REFERER']) && strtolower(substr($_SERVER['HTTP_REFERER'], 0, 5)) == 'https') ? true : false;
      $this->sc_protocolo    = ($this->sc_site_ssl) ? 'https://' : 'http://';
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/grafico-aluno';
      ...
      {
          include_once("grid_tbl_aluno_1_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno_1']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno_1']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno_1']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno_1']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_add_dyn_search")
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno_1']['dyn_search_add']['cmp'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno_1']['dyn_search_add']['seq'] = $_POST['seq'];
          $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno_1']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
      if (isset($_GET['nmgp_opcao']) && $_GET['nmgp_opcao'] == "ajax_aut_comp_dyn_search")
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno_1']['dyn_search_aut_comp']['cmp'] = $_GET['field'];
          $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno_1']['opcao'] = $_GET['origem'];
...
<?php
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_conexao']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno_1']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "grid_tbl_aluno_1_erro.class.php"); 
      $this->Erro = new grid_tbl_aluno_1_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('grid_tbl_aluno_1'); 
// 
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno_1']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno_1']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      ob_start();
      $this->prep_conect();
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno_1']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno_1']['initialize'])  
      { 
          $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno_1']['Gera_log_access'] = true;
          $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno_1']['initialize']      = false;
      } 
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_conexao']) && $_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_perfil']) && $_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno_1']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno_1']['embutida_init']) 
      {
      }
// 
      if (isset($_SESSION['scriptcase']['glo_decimal_db']) && !empty($_SESSION['scriptcase']['glo_decimal_db']))
      {
         $_SESSION['sc_session'][$this->sc_page]['grid_tbl_aluno_1']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_conexao'], $this->root . $this->path_prod, 'ISchool'); 
      } 
      else 
      { 
...
//
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'grid_tbl_aluno_1', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'grid_tbl_aluno_1', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'grid_tbl_aluno_1', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//===============================================================================
//
class grid_tbl_aluno_1_sub_css
{
   function grid_tbl_aluno_1_sub_css()
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['grid_tbl_aluno_1']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['grid_tbl_aluno_1'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class grid_tbl_aluno_1_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      global $nm_saida, $nm_url_saida, $script_case_init, $nmgp_parms_pdf, $nmgp_graf_pdf, $nm_apl_dependente, $nmgp_navegator_print, $nmgp_tipo_print, $nmgp_cor_print, $nmgp_cor_word, $NMSC_conf_apl, $NM_contr_var_session, $NM_run_iframe,
             $glo_senha_protect, $nmgp_opcao, $nm_call_php, $nmgp_chave_det, $nmgp_parm_acum;

      if ($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['embutida'])
      { 
          ...
          { 
              ...
              foreach ($todo as $param)
              {
                   ...
                   if (1 < sizeof($cadapar))
                   {
                       ...
                       nm_limpa_str_grid_tbl_aluno_1($cadapar[1]);
                       nm_protect_num_grid_tbl_aluno_1($cadapar[0], $cadapar[1]);
                       $$cadapar[0] = $cadapar[1];
                   }
              }
          } 
      ...
      if (!$this->Ini) 
      { 
          $this->Ini = new grid_tbl_aluno_1_ini(); 
          $this->Ini->init();
      } 
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("pt_br");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "grafico-aluno/grid_tbl_aluno_1_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "grid_tbl_aluno_1_erro.class.php"); 
      } 
      $this->Erro      = new grid_tbl_aluno_1_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "grafico-aluno/grid_tbl_aluno_1_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "grid_tbl_aluno_1_lookup.class.php"); 
      } 
      $this->Lookup       = new grid_tbl_aluno_1_lookup();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['SC_All_Groupby'] = array('Aluno' => 'all');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if ($Tp == "grid")
              {
                  continue;
              }
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['SC_Ind_Groupby'] = $Ind;
      } 
      $this->Ini->Apl_resumo  = "grid_tbl_aluno_1_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "grid_tbl_aluno_1_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['SC_Ind_Groupby'] . ".class.php"; 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['Gera_log_access'])
      {
          $this->Ini->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['Gera_log_access'] = false;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pdf_det'] = false;
      if ($nmgp_opcao == 'pdf_det')
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pdf_det'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] = 'pdf';
          $nmgp_opcao = 'pdf';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pdf_res'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] = 'pdf';
          $nmgp_opcao = 'pdf';
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_tipo']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_disp']        = array('Pyramid');
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_tipo']        = 'Pyramid';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_larg']        = 600;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_alt']         = 300;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_opc_atual']   = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_mod_allowed'] = array(1, 2);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_order']       = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_font']        = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_subtitle_val'] = 'below';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['chartpallet']       = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_exibe_val']    = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['paletteColors']     = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_barra_orien'] = 'Vertical';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_barra_forma'] = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_barra_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_barra_sobre'] = 'No';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_barra_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_barra_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_barra_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_barra_funil'] = 'N';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_pizza_forma'] = 'Pie';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_pizza_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_pizza_orden'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_pizza_explo'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_pizza_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_linha_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_linha_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_linha_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_area_forma']  = 'Area';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_area_empil']  = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_area_inver']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_area_agrup']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_marca_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_marca_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_gauge_forma'] = 'Circular';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_radar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_radar_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_polar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_funil_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_funil_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_pyram_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_pyram_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_pyram_forma'] = 'S';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida_treeview'] = false;
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['field_order']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['field_order'][] = "id";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['field_order'][] = "matricula";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['field_order'][] = "nome";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['field_order'][] = "foto";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['field_order'][] = "sexo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['field_order'][] = "cpf";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['field_order'][] = "rg";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['field_order'][] = "estadocivil";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['field_order_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['field_order'];
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['usr_cmp_sel']))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['usr_cmp_sel'] = array();
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['usr_cmp_sel']['estadocivil'] = "off";
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbl_aluno_1']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbl_aluno_1']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['grid_tbl_aluno_1']['exit'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_orig']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] = "resumo" ;  
      }   
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbl_aluno_1']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbl_aluno_1']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] = "busca";
          }   
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida_form'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "busca")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] = "inicio";
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"]))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opc_liga'] = $NMSC_conf_apl;  
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['print_all'] = true;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['det_print'] = "";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "det_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao']     = "detalhe";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['det_print'] = "print";
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "fast_search")  
      { 
          $this->SC_fast_search($GLOBALS["nmgp_fast_search"], $GLOBALS["nmgp_cond_fast_search"], $GLOBALS["nmgp_arg_fast_search"]);
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq'])
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] = 'igual';
          } 
          else 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq'];
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] = 'pesq';
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['orig_pesq'] = 'grid';
          } 
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "dyn_search" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "dyn_search_clear")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "dyn_search_clear")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['dyn_search_clear'] = true;
          } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] = 'inicio';
          } 
      } 
//
      ...
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'], 0, 7) != "grafico" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['prim_cons'] = true;  
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq_fast'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['contr_total_geral'] = "NAO";
   ...
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq_filtro'];
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida'])
      {
         ...
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grid_tbl_aluno_1_html_" . session_id() . "_2.html";
            ...
            {
                $nm_arquivo_pdf_base = "/sc_pdf_" . date("YmdHis") . "_" . rand(0, 1000) . "_grid_tbl_aluno_1.pdf";
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            }
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grid_tbl_aluno_1_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->java_protocol . $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_grid_tbl_aluno_1_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "doc_word_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['print_navigator'] = "Microsoft Internet Explorer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['print_all'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['doc_word']  = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao']     = "resumo";
          $_SESSION['scriptcase']['saida_word'] = true;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['word_name']))
          {
              $nm_arquivo_doc_word = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['word_name'];
          }
          else
          {
              $nm_arquivo_doc_word = "/sc_grid_tbl_aluno_1_res_" . session_id() . ".doc";
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "xls")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grafico-aluno/grid_tbl_aluno_1_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_tbl_aluno_1_xls.class.php"); 
          } 
          $this->xls  = new grid_tbl_aluno_1_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "xml")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grafico-aluno/grid_tbl_aluno_1_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_tbl_aluno_1_xml.class.php"); 
          } 
          $this->xml  = new grid_tbl_aluno_1_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "csv")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grafico-aluno/grid_tbl_aluno_1_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_tbl_aluno_1_csv.class.php"); 
          } 
          $this->csv  = new grid_tbl_aluno_1_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "rtf")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grafico-aluno/grid_tbl_aluno_1_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_tbl_aluno_1_rtf.class.php"); 
          } 
          $this->rtf  = new grid_tbl_aluno_1_rtf();
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida'])
          { 
              require_once($this->Ini->path_embutida . " . grafico-aluno . /" . $this->Ini->Apl_grafico); 
          } 
          else 
          { 
          ...
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'], 8));
          }
          else
          { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "grid_tbl_aluno_1_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_tbl_aluno_1_mobile_pesq.class.php"); 
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq'];  
          $this->pesq  = new grid_tbl_aluno_1_pesq();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "resumo" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "pesq")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grafico-aluno/" . $this->Ini->Apl_resumo); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
          } 
          $this->Res = new grid_tbl_aluno_1_resumo("out");
          $this->prep_modulos("Res");
          $this->Res->monta_resumo();
      }
      else 
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "print" && $nmgp_tipo_print == "RC")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['print_navigator'] = $nmgp_navegator_print;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao']     = "pdf";
              $GLOBALS['nmgp_tipo_pdf'] = strtolower($nmgp_cor_print);
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "doc_word")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['print_navigator'] = "Microsoft Internet Explorer";
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['doc_word']  = true;
              ...
              {
                  $nm_arquivo_doc_word = "/sc_grid_tbl_aluno_1_" . session_id() . ".doc";
              }
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word);
          ...
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['chave_det'] = $nmgp_chave_det;
          } 
          if (isset($nmgp_parm_acum))  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['cmp_acum'] = $nmgp_parm_acum;
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['opcao'] == "detalhe" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pdf_det'])  
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida'])
              { 
                  require_once($this->Ini->path_embutida . "grafico-aluno/grid_tbl_aluno_1_det.class.php"); 
              } 
              else 
              { 
                  require_once($this->Ini->path_aplicacao . "grid_tbl_aluno_1_det.class.php"); 
              } 
              $this->det  = new grid_tbl_aluno_1_det();
          ...
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida'])
              { 
                  require_once($this->Ini->path_embutida . "grafico-aluno/grid_tbl_aluno_1_grid.class.php"); 
              } 
              else 
              { 
                  require_once($this->Ini->path_aplicacao . "grid_tbl_aluno_1_grid.class.php"); 
              } 
              $this->grid  = new grid_tbl_aluno_1_grid();
...
//--- 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['embutida'])
      {
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['word_file'] = $this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pdf_det'])
            {
            ...
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pdf_name']))
            {
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pdf_name']);
            }
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pdf_file'] = $nm_arquivo_pdf_serv;
}
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pdf_det'])
{
...
$NM_volta  = "volta_grid";
$NM_target = "_parent";
if ($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['pdf_res'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
...
<HEAD>
 <TITLE>Relatório de Alunos :: PDF</TITLE>
...
<?php
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          $tmp_cmd = "";
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_orig'])) 
          {
              $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_orig']; 
          }
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq_filtro'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq_filtro'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq_filtro'] . ")"; 
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq'] = $tmp_cmd;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['fast_search']);
          return;
      }
      $comando = "";
      $sv_data = $data_search;
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "formaIngresso", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "estados_id_nasc", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "cidades_id_nasc", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "estados_id_res", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "cidades_id_res", $arg_search, $data_search);
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq_fast'] = $comando;
      $tmp_cmd = "";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_orig'])) 
      {
          $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_orig']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['fast_search'][2] = $sv_data;
   }
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['decimal_db'] == ".")
         {
             $nm_aspas = "";
         }
         if (is_array($campo))
   ...
   function SC_lookup_estadocivil($condicao, $campo)
   {
       $data_look = array();
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       $data_look['1'] = "Solteiro(a)";
       $data_look['2'] = "Casado(a)";
       $result = array();
       foreach ($data_look as $chave => $label) 
       {
           if ($condicao == "eq" && $campo == $label)
   ...
   function SC_proc_dyn_search($Parms)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['dyn_search'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['dyn_refresh'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['tmp_busca'] = array();
       foreach ($tmp as $cada_f)
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['dyn_search'][] = array('cmp' => $dats[0], 'opc' => $dats[1], 'val' => $val_sv);
           $ix++;
       }
      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['tmp_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['tmp_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['tmp_busca'] as $ind => $dados)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['campos_busca'][$ind] = $dados;
      }
       $this->Dyn_Serarch_and_or = "and";
       $this->Cmd_Dyn_Search    = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['cond_dyn_search'] = "";
       foreach ($fields as $ind => $dados)
       {
           ...
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['dyn_search_label']['id'];
           ...
           if ($dados['field'] == "matricula" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['dyn_search_label']['matricula'];
               $dados['vls'][0] = $dados['vls'][0][0];
               $this->Val_format_1 = $dados['vls'][0];
               $this->SC_proc_dyn_search_all($dados['cond'], $dados['vls'], "matricula", 'A', 'VARCHAR', $Label_cmp);
           }
           if ($dados['field'] == "nome" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['dyn_search_label']['nome'];
               $dados['vls'][0] = $dados['vls'][0][0];
               $this->Val_format_1 = $dados['vls'][0];
               $this->SC_proc_dyn_search_all($dados['cond'], $dados['vls'], "nome", 'A', 'VARCHAR', $Label_cmp);
           }
           if ($dados['field'] == "foto" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['dyn_search_label']['foto'];
               $dados['vls'][0] = $dados['vls'][0][0];
               $this->Val_format_1 = $dados['vls'][0];
               $this->SC_proc_dyn_search_all($dados['cond'], $dados['vls'], "foto", 'A', 'VARCHAR', $Label_cmp);
           }
           if ($dados['field'] == "sexo" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['dyn_search_label']['sexo'];
               $dados['vls'][0] = $dados['vls'][0][0];
               if ($dados['cond'] == "BW")
               {
                   $dados['vls'][1] = $dados['vls'][1][0];
               ...
               $this->SC_proc_dyn_search_all($dados['cond'], $dados['vls'], "sexo", 'N', 'INT', $Label_cmp);
           }
           if ($dados['field'] == "datanascimento" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['dyn_search_label']['datanascimento'];
               if ($dados['cond'] != "TP")
               {
                   ...
                   $this->nm_prep_date($val, "DT", "DATETIME", $dados['cond'] , "");
                   $this->Val_format_1 = $val[0];
                   $this->nm_data->SetaData($this->Val_format_1, "YYYY-MM-DD HH:II:SS");
                   $this->Val_format_1 = $this->nm_data->FormataSaida($this->Nm_date_format("DH", "ddmmaaaa;hhiiss"));
                   if ($dados['cond'] == "BW")
                   {
                       $this->Val_BW_2     = $val[1];
                       $this->Val_format_2 = $val[1];
                       $this->nm_data->SetaData($this->Val_format_2, "YYYY-MM-DD HH:II:SS");
                       $this->Val_format_2 = $this->nm_data->FormataSaida($this->Nm_date_format("DH", "ddmmaaaa;hhiiss"));
                   }
                   $this->SC_proc_dyn_search_all($dados['cond'], $val, "dataNascimento", 'DT', 'DATETIME', $Label_cmp);
               }
           }
       }
       if (empty($this->Cmd_Dyn_Search)) 
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['cond_pesq']         = "";
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['cond_dyn_search']   = "";
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['campos_busca']      = array();
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq_fast'])) 
           {
               if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq'])) 
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq_fast'] . ")";
               }
               else 
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq_fast'] . ")";
               }
           }
           return;
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq_filtro'] = "( " . $this->Cmd_Dyn_Search . " )";
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_orig'])) 
       {
           $this->Cmd_Dyn_Search = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_orig'] . " and (" . $this->Cmd_Dyn_Search . ")"; 
       }
       else
       {
           $this->Cmd_Dyn_Search = " where " . $this->Cmd_Dyn_Search; 
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq'] = $this->Cmd_Dyn_Search;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['cond_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['cond_dyn_search'] . $this->Dyn_Serarch_and_or;
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq_fast'])) 
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['where_pesq_fast'] . ")";
       }
       if (NM_is_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['cond_pesq']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['cond_pesq'] = mb_convert_encoding($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['cond_pesq'], $_SESSION['scriptcase']['charset'], "UTF-8");
       }
   }
   function SC_proc_dyn_search_lookup($cond, $vls, $sql, $tp, $tsql, $lab)
   {
       ...
       if (!empty($nm_cmd))
       {
           ...
           if ($cond == "DF")
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['cond_dyn_search'] .= $lab . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $nm_cond . "##*@@";
           }
           else
           {
               $this->Cmd_Dyn_Search .= "(" . $sql . " in (" . $nm_cmd . "))";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['cond_dyn_search'] .= $lab . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
           }
       }
   }
   ...
   {
       $nm_aspas = "'";
       if ($tp == "N" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['decimal_db'] == ".")
       {
           $nm_aspas = "";
       }
      if (($tp == "DT" || $tp == "DH" || $tp == "HH") && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      {
       ...
       $dados   = $vls[0];
           ...
           if (!empty($nm_cmd))
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['cond_dyn_search'] .= $nm_cond;
           }
   }
...
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE>Relatório de Alunos :: Doc</TITLE>
...
<input type="hidden" name="nm_tit_doc" value="grid_tbl_aluno_1.doc"> 
...
<form name="Fdown" method="get" action="grid_tbl_aluno_1_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="nm_tit_doc" value="grid_tbl_aluno_1_det.pdf"> 
...
//======= =========================
   ...
   $_SESSION['scriptcase']['grid_tbl_aluno_1']['contr_erro'] = 'off';
   $sc_conv_var = array();
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_grid_tbl_aluno_1($nmgp_val);
            nm_protect_num_grid_tbl_aluno_1($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['grid_tbl_aluno_1']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['grid_tbl_aluno_1']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['grid_tbl_aluno_1']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['grid_tbl_aluno_1']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['grid_tbl_aluno_1']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['grid_tbl_aluno_1']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['grid_tbl_aluno_1']['embutida_form_parms']);
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']);
               $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['b_sair'] = false;
           }   
       } 
   } 
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['grid_tbl_aluno_1']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['grid_tbl_aluno_1']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['grid_tbl_aluno_1']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['grid_tbl_aluno_1']['protect_modal']) && !empty($_SESSION['scriptcase']['grid_tbl_aluno_1']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['grid_tbl_aluno_1']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        {
            $_SESSION['scriptcase']['sc_apl_menu_atual'] = "grid_tbl_aluno_1";
        }
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            ...
            {
                if ($nome_apl == 'grid_tbl_aluno_1' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['initialize'] = false;
   }
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/grafico-aluno/'))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['initialize'] = true;
   }
   else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['contr_total_geral'] = "NAO";
   }

   $_POST['script_case_init'] = $script_case_init;
   if (isset($nmgp_opcao) && $nmgp_opcao == "busca" && isset($nmgp_orig_pesq))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['orig_pesq'] = $nmgp_orig_pesq;
   }
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['b_sair'] = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'grid_tbl_aluno_1')
   {
       $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/grid_tbl_aluno_1_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           foreach ($todo as $param)
           {
                $delimit = "'";
                $cadapar = explode("?#?", $param);
                if ($cadapar[0] == "estadocivil")  
                { 
                    $cadapar[0] = str_replace("estadocivil", "estadoCivil", $cadapar[0]);
                } 
                if ($cadapar[0] == "datanascimento")  
                { 
                    $cadapar[0] = str_replace("datanascimento", "dataNascimento", $cadapar[0]);
                } 
                if ($cadapar[0] == "orgaoexpedidor")  
                { 
                    $cadapar[0] = str_replace("orgaoexpedidor", "orgaoExpedidor", $cadapar[0]);
                } 
                if ($cadapar[0] == "dataexpedicao")  
                { 
                    $cadapar[0] = str_replace("dataexpedicao", "dataExpedicao", $cadapar[0]);
                } 
                if ($cadapar[0] == "formaingresso")  
                { 
                    $cadapar[0] = str_replace("formaingresso", "formaIngresso", $cadapar[0]);
                } 
                if ($cadapar[0] == "dataformatura")  
                { 
                    $cadapar[0] = str_replace("dataformatura", "dataFormatura", $cadapar[0]);
                } 
                if ($cadapar[0] == "nomemae")  
                { 
                    $cadapar[0] = str_replace("nomemae", "nomeMae", $cadapar[0]);
                } 
                if ($cadapar[0] == "nomepai")  
                { 
                    $cadapar[0] = str_replace("nomepai", "nomePai", $cadapar[0]);
                } 
                if ($cadapar[0] == "numerocel")  
                { 
                    $cadapar[0] = str_replace("numerocel", "numeroCel", $cadapar[0]);
                } 
                if ($cadapar[0] == "numerotel")  
                { 
                    $cadapar[0] = str_replace("numerotel", "numeroTel", $cadapar[0]);
                } 
                if ($cadapar[0] == "numeroprof")  
                { 
                    $cadapar[0] = str_replace("numeroprof", "numeroProf", $cadapar[0]);
                } 
                if ($cadapar[0] == "emailpessoal")  
                { 
                    $cadapar[0] = str_replace("emailpessoal", "emailPessoal", $cadapar[0]);
                } 
                if ($cadapar[0] == "emailprofissional")  
                { 
                    $cadapar[0] = str_replace("emailprofissional", "emailProfissional", $cadapar[0]);
                } 
                if ($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['SC_Ind_Groupby'] == "Aluno")
                { 
                    $Temp_parms .= (empty($Temp_parms)) ? "" : " and ";
                    $Temp_parms .= $cadapar[0] . " = " . str_replace("@aspass@", $delimit, $cadapar[1]) ;
                } 
           }
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['where_resumo'] = $Temp_parms;
       } 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['opcao'] = $nmgp_opcao ;  
       }   
       if ($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['opcao'] == "detalhe" && isset($nmgp_chave_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['chave_det'] = $nmgp_chave_det;
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['cmp_acum']  = $nmgp_parm_acum;
       }   
       if (isset($nmgp_lig_edit_lapis)) 
       {
          $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['volta_redirect_tp'] = "";
           $nm_url_saida = "grid_tbl_aluno_1_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['sc_modal'] = true;
               }
               $nm_url_saida = "grid_tbl_aluno_1_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['opcao'] != "pdf" ) 
       { 
            $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['menu_desenv'] = true;   
       } 
       if (isset($_GET["nmgp_parms_ret"])) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['opc_psq'] = true ;   
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['opc_psq'] = false ;   
       } 
       if ($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['embutida_form'])
       {
           $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['mostra_edit'] = "N";   
       ...
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['grid_tbl_aluno_1'] = "on";
       } 
       if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['grid_tbl_aluno_1'] = "on";
       } 
       if (!$_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['opc_psq']) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tbl_aluno_1']) || $_SESSION['scriptcase']['sc_apl_seg']['grid_tbl_aluno_1'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['iframe_menu']) ? false : true;
...
<?php
       ...
       $contr_grid_tbl_aluno_1 = new grid_tbl_aluno_1_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['opcao'] = "busca";
          $contr_grid_tbl_aluno_1->NM_ajax_flag = true;
          $contr_grid_tbl_aluno_1->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['opcao'] = "busca";
          $contr_grid_tbl_aluno_1->NM_ajax_flag = true;
          $contr_grid_tbl_aluno_1->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['opcao'] = "busca";
          $contr_grid_tbl_aluno_1->NM_ajax_flag = true;
          $contr_grid_tbl_aluno_1->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['opcao'] = "busca";
          $contr_grid_tbl_aluno_1->NM_ajax_flag = true;
          $contr_grid_tbl_aluno_1->NM_ajax_opcao = "ajax_filter_select";
      }
       $contr_grid_tbl_aluno_1->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['grid_tbl_aluno_1']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_grid_tbl_aluno_1(&$str)
   {
   ...
   function nm_protect_num_grid_tbl_aluno_1($name, &$val)
   {
       if (empty($val))
       {
          return;
       ...
       $Nm_numeric[] = "id";
       $Nm_numeric[] = "sexo";
       $Nm_numeric[] = "estadocivil";
       $Nm_numeric[] = "formaingresso";
       $Nm_numeric[] = "estados_id_nasc";
       $Nm_numeric[] = "cidades_id_nasc";
       $Nm_numeric[] = "estados_id_res";
       $Nm_numeric[] = "cidades_id_res";
   ...
   function grid_tbl_aluno_1_pack_protect_string($sString)
   {
