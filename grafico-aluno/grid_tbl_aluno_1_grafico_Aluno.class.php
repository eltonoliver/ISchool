...
class grid_tbl_aluno_1_grafico
{
   var $Db;
   var $Ini;
   var $Erro;
   ...
   //---- 
   function grid_tbl_aluno_1_grafico()
   {
   ...
   function monta_grafico($chart_key = '', $operation = 'chart', $graf_col = false)
   {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['parms_graf'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'];
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_opc_atual'] == 1)
       {
           $this->sc_graf_sint = true;
       }
       ...
       {
           $b_export = true;
           $chart_key = key($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_charts']);
       }
       elseif ('' == $chart_key)
       {
       ...
       if ($graf_field)
       {
           ...
           $arr_param = array(
               'type'        => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_tipo'],
               'width'       => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_larg'],
               'height'      => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_alt'],
               'barra_orien' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_barra_orien'],
               'barra_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_barra_forma'],
               'barra_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_barra_dimen'],
               'barra_sobre' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_barra_sobre'],
               'barra_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_barra_empil'],
               'barra_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_barra_inver'],
               'barra_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_barra_agrup'],
               'barra_funil' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_barra_funil'],
               'pizza_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_pizza_forma'],
               'pizza_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_pizza_dimen'],
               'pizza_orden' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_pizza_orden'],
               'pizza_explo' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_pizza_explo'],
               'pizza_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_pizza_valor'],
               'linha_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_linha_forma'],
               'linha_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_linha_inver'],
               'linha_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_linha_agrup'],
               'area_forma'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_area_forma'],
               'area_empil'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_area_empil'],
               'area_inver'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_area_inver'],
               'area_agrup'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_area_agrup'],
               'marca_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_marca_inver'],
               'marca_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_marca_agrup'],
               'gauge_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_gauge_forma'],
               'radar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_radar_forma'],
               'radar_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_radar_empil'],
               'polar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_polar_forma'],
               'funil_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_funil_dimen'],
               'funil_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_funil_inver'],
               'pyram_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_pyram_dimen'],
               'pyram_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_pyram_valor'],
               'pyram_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field]['graf_pyram_forma'],
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['parms_graf'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1'][$field];
           $this->grafico_flash($arr_param, $this->grafico_dados($chart_data, $arr_param['export']), $mode);
       }
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_charts'][$chart_key]))
       {
           $chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['pivot_charts'][$chart_key];

           $arr_param = array(
               'type'        => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_tipo'],
               'width'       => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_larg'],
               'height'      => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_alt'],
               'barra_orien' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_barra_orien'],
               'barra_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_barra_forma'],
               'barra_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_barra_dimen'],
               'barra_sobre' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_barra_sobre'],
               'barra_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_barra_empil'],
               'barra_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_barra_inver'],
               'barra_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_barra_agrup'],
               'barra_funil' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_barra_funil'],
               'pizza_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_pizza_forma'],
               'pizza_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_pizza_dimen'],
               'pizza_orden' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_pizza_orden'],
               'pizza_explo' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_pizza_explo'],
               'pizza_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_pizza_valor'],
               'linha_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_linha_forma'],
               'linha_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_linha_inver'],
               'linha_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_linha_agrup'],
               'area_forma'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_area_forma'],
               'area_empil'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_area_empil'],
               'area_inver'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_area_inver'],
               'area_agrup'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_area_agrup'],
               'marca_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_marca_inver'],
               'marca_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_marca_agrup'],
               'gauge_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_gauge_forma'],
               'radar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_radar_forma'],
               'radar_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_radar_empil'],
               'polar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_polar_forma'],
               'funil_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_funil_dimen'],
               'funil_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_funil_inver'],
               'pyram_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_pyram_dimen'],
               'pyram_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_pyram_valor'],
               'pyram_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_pyram_forma'],
               'tit_datay'   => $chart_data['label_y'],
               'tit_label'   => $chart_data['label_x'],
               'tit_chart'   => $chart_data['title'],
           ...
           elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_full'])
           {
               $mode = 'full';
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_full']);
           }
           elseif (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_bot'])
           {
               $mode = 'full';
           }
           elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_first'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_first'] = false;
               $mode = array('js', 'chart');
           }
           else
           {
           ...
           elseif ((!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']) && (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_bot']))
           {
               exit;
           }
       }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_opc_atual'] == 1)
      {
         $this->sc_graf_sint = true;
      }
      //---- 
      ...
      $this->label    = array();
      $this->label[0] = "Nome";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['contr_label_graf']['nome']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['contr_label_graf']['nome']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['contr_label_graf']['nome'];
      }
   }
   ...
   function monta_arrays()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_total']))
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_total'] as $label => $valor)
          {
          ...
          if (!$this->sc_graf_sint)
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_linhas'] as $cada_elemento)
              {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_linhas']))
      {
          if ($this->campo > 0)
          {
              $lab_quebra    = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_linhas'][$this->campo][0], 1);
              $lab_quebra    = str_replace("&nbsp;", "", $lab_quebra);
              $this->titulo .= " - " . $this->label[$this->nivel] . " = " . $lab_quebra;
          }
          if ($this->campo > 0)
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_linhas'][$this->campo] as $ind => $valor)
              {
                  if ($ind > 0)
                  {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['del_graph_col']))
      {
          ...
          {
              $tst_ind = $ind + 1;
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['del_graph_col'][$tst_ind]))
              {
   ...
   function grafico_flash($arr_param, $arr_charts, $html_par = 'full')
   {
      global $nm_saida, $nm_retorno_graf;
         ...
         $this->orderCharts($arr_charts, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['parms_graf']['graf_order']);
...
<?php
   ...
   function grafico_flash_xml($arr_param, $arr_series, $newline = "\r\n")
   {
       ...
       if ($chart_theme)
       {
           ...
           if ($chart_theme['css_chart_font_size'] && '' != $chart_theme['css_chart_font_size'] && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['parms_graf']['graf_font']))
           {
       ...
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['parms_graf']['graf_font']))
       {
           $chart_attr[] = "baseFontSize=\"" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['parms_graf']['graf_font'] . "\"";
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['parms_graf']['chartpallet']) && false == $chart_theme)
       {
           $chart_attr[] = "palette=\"" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['parms_graf']['chartpallet'] . "\"";
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['parms_graf']['graf_subtitle_val'] == 'right')
       {
           $chart_attr[] = "legendPosition=\"RIGHT\"";
       }

       $s_xml = "<chart showValues=\"" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['parms_graf']['graf_exibe_val'] . "\" caption=\"" . $this->formatFusionLabel($tit_graf) . "\" xAxisName=\"" . $this->formatFusionLabel($tit_label) . "\" yAxisName=\"" . $this->formatFusionLabel($tit_datay) . "\"";
       if (false == $chart_theme)
       {
           $s_xml .= " paletteColors=\"" . $this->getColorList($arr_series, $_SESSION["sc_session"][$this->Ini->sc_page]["grid_tbl_aluno_1"]["parms_graf"]["paletteColors"]) . "\"";
       }
       ...
       elseif (1 < sizeof($arr_series) || 'Radar' == $tipo || 'Step' == $arr_param['linha_forma'])
       {
           ...
           foreach ($arr_series as $arr_serie)
           {
               ...
               $s_xml    .= " <dataset" . $series_nm . ">" . $newline;
               foreach ($label as $iIndex => $sLabel)
               {
...
<?php
   ...
   function grafico_flash_config_js()
   {
      ...
      $sUrlConfigSave = $this->Ini->path_link . "grafico-aluno/grid_tbl_aluno_1_config_graf_flash.php?nome_apl=grid_tbl_aluno_1&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br";
      ...
      $nm_saida->saida("          nome_apl: \"grid_tbl_aluno_1\",\r\n");
   ...
   function grafico_flash_config_div()
   {
      ...
      $aChartDisp        = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_disp'])      && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_disp']))    ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_disp']      : array('Pyramid');
      $sChartType        = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_tipo'])      && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_tipo'])      ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_tipo']      : 'Pyramid';
      $iSinteticAnalitic = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_opc_atual']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_opc_atual']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_opc_atual'] : '1';
      $iChartWidth       = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_larg'])      && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_larg'])      ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_larg']      : '600';
      $iChartHeight      = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_alt'])       && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_alt'])       ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_alt']       : '300';
      $sChartOrder       = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_order'])     && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_order'])     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['graf_order']     : '';
   ...
   function grafico_flash_chart($width, $height, $sFileLocal, $export, $arr_charts, $isPDF = 'N')
   {
      ...
      if ($_SESSION['scriptcase']['phantomjs_charts'] && "Y" == $isPDF)
      {
          ...
          {
              $sTmpId = $sChartXml . $width . $height . $this->getChartModule() . $this->getChartType($bMulti);
          }
          $sTmpId       = md5($sTmpId . 'grid_tbl_aluno_1');
          $sImageName   = 'sc_pjs_png_' . $sTmpId . '.png';
          $sImageUrl    = $_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_path_imag_temp'] . '/' . $sImageName;
          $sImageFile   = $this->Ini->root . $sImageUrl;
          $sPDFHtmlCall = "";
          $sAppDir      = getcwd();
          $aOS          = $this->Ini->getRunningOS();
          $sPhantomCmd  = 'phantomjs "' . $this->Ini->root . $_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_path_imag_temp'] . '/sc_pjs_js_' . $sTmpId . '.js"';
          $iJsDelay     = 150;
          if ('win' != $aOS['os'])
          {
          ...
          if (!$bImageGenerated || $iImageSize < $iImageSizeLimit)
          {
              ...
              $this->generatePhantomPhp($sTmpId, $bMulti, $width, $height, $sFileLocal);
      ...
      elseif ($_SESSION['scriptcase']['fusioncharts_new'])
      {
          ...
          $sPDFHtmlCall .= "    'type': '" . $this->getChartType($bMulti) . "',";
      ...
      else
      {
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['charts_html'] = "  FusionCharts.setCurrentRenderer('javascript');";
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['charts_html'] .= $sPDFHtmlCall;
      }
   }

   function generatePhantomJs($sTmpId, $sImageFile, $iDelay)
   {
       $fPhantomJs = @fopen($this->Ini->root . $_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_path_imag_temp'] . '/sc_pjs_js_' . $sTmpId . '.js', 'w');
   ...
   function generatePhantomPhp($sTmpId, $bMulti, $width, $height, $sFileLocal)
   {
       $fPhantomChart = @fopen($this->Ini->root . $_SESSION['scriptcase']['grid_tbl_aluno_1']['glo_nm_path_imag_temp'] . '/sc_pjs_php_' . $sTmpId . '.php', 'w');
       ...
       @fwrite($fPhantomChart, "    'type': '" . $this->getChartType($bMulti) . "',\r\n");
   ...
   function getChartType($bMulti)
   {
       return strtolower($this->getChartRenderer($bMulti));
   }
   ...
   function getChartRenderer($bMulti)
   {
       $sChart = '';
       $sMulti = $bMulti ? 'MS' : '';
       switch ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['parms_graf']['graf_tipo'])
       {
           case 'Bar':
               if ('Horizontal' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['parms_graf']['graf_barra_orien'])
               {
                   if ('Off' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['parms_graf']['graf_barra_empil'] && $bMulti)
                   {
                       $sChart .= 'StackedBar';
                       $sChart .= '3d' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['parms_graf']['graf_barra_dimen']  ? '3D' : '2D';
                   }
                   else
                   {
                       $sChart .= $sMulti . 'Bar';
               ...
               else
               {
                   if ('Off' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['parms_graf']['graf_barra_empil'] && $bMulti)
                   {
                       ...
                       $sChart .= '2d' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['parms_graf']['graf_barra_dimen'] ? '2D' : '3D';
                   }
                   else
                   {
               ...
               break;
           case 'Pie':
               if ('Pie' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['parms_graf']['graf_pizza_forma'])
               {
                   $sChart .= 'Pie';
               }
               else
               ...
               $sChart .= '2d' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['parms_graf']['graf_pizza_dimen'] ? '2D' : '3D';
               break;
           case 'Line':
               if ('Line' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['parms_graf']['graf_linha_forma'])
               {
                   $sChart .= $sMulti . 'Line';
               }
               elseif ('Spline' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['parms_graf']['graf_linha_forma'])
               {
               ...
               break;
           case 'Area':
               if ('Area' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['parms_graf']['graf_area_forma'])
               {
                   if ($bMulti)
                   {
                       $sChart .= $sMulti . 'Area';
   ...
   function getChartModule($sChartType = '')
   {
       if ('' == $sChartType)
       {
           $sChartType = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['parms_graf']['graf_tipo'];
       }
       switch ($sChartType)
       {
           case 'Bar':
