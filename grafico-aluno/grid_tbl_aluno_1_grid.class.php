...
<HEAD>
 <TITLE>Relat贸rio de Alunos :: PDF</TITLE>
...
<?php
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>Relat贸rio de Alunos</TITLE>\r\n");
       ...
       { 
           ...
           $Msg_Inval = mb_convert_encoding("Inv醠ido", $_SESSION['scriptcase']['charset']);
...
//----- 
 function cabecalho()
 {
   ...
   $nm_saida->saida("    	<tr>\r\n");
   $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"" . $this->css_scGridHeaderFont . "\"><span>Relat贸rio de Alunos</span></td>\r\n");
...
// 
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['id'])) ? $this->New_label['id'] : "C贸digo"; 
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['matricula'])) ? $this->New_label['matricula'] : "Matr铆cula"; 
...
// 
 function gera_icone($doc) 
 {
   ...
   function html_dynamic_search()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['dyn_search_label']['id'] = (isset($this->New_label['id'])) ? $this->New_label['id'] : "C贸digo";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['dyn_search_label']['matricula'] = (isset($this->New_label['matricula'])) ? $this->New_label['matricula'] : "Matr铆cula";
