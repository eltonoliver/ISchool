...
class grid_tbl_aluno_1_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".rtf";
      $this->tit_doc    = "grid_tbl_aluno_1.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['rtf_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['rtf_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['rtf_name']);
      }
   ...
   function NM_export_foto()
   {
         ...
         {
             $this->foto = mb_convert_encoding($this->foto, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_aluno_1']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE>Relatório de Alunos :: RTF</TITLE>
